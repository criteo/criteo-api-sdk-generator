...
class TestPushSdkAction:
  ...
  def test_tag_successful(self, api_version, failure_count, expected_tag):
    ...
    action = PhpSdkPushAction(git_client, fs_client, self.os_client_builder.client)
  ...
  def test_tag_should_fail_when_tag_retries_exceed_max(self):
    ...
    action = PhpSdkPushAction(git_client, self.fs_client_builder.client, self.os_client_builder.client)
