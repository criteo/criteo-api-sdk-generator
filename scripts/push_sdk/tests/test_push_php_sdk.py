...
class TestPushSdkAction:
  ...
  def test_execute_should_fail_when_sdks_folder_not_found(self):
    ...
    pipeline = PushPhpSdkPipeline(self.git_client_builder.client, fs_client, self.os_client_builder.client)
  ...
  def test_tag_successful(self, api_version, failure_count, expected_tag):
    ...
    pipeline = PushPhpSdkPipeline(git_client, fs_client, self.os_client_builder.client)
  ...
  def test_tag_should_fail_when_tag_retries_exceed_max(self):
    ...
    pipeline = PushPhpSdkPipeline(git_client, self.fs_client_builder.client, self.os_client_builder.client)
