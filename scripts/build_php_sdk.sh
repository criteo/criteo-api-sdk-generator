...
echo "Building SDK - PHP"

get_next_patch_number "https://github.com/criteo/criteo-api-php-sdk"
${GRADLEW} :generator:php:generateClient -Dorg.gradle.project.buildNumber=${NEXT_PATCH_NUMBER}

# write version into a file
nextVersion="v${API_VERSION}.${NEXT_PATCH_NUMBER}"
VERSION_FILE="/tmp/gh_${BUILD_NUMBER}-build_sdk-php.version"
