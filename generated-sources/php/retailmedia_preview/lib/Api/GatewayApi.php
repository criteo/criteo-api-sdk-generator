...
/**
     ...
     * @return \criteo\api\retailmedia\preview\Model\ApplicationSummaryModelResponse
     */
     ...
     * @throws \criteo\api\retailmedia\preview\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\preview\Model\ApplicationSummaryModelResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCurrentApplicationWithHttpInfo(string $contentType = self::contentTypes['getCurrentApplication'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\preview\Model\ApplicationSummaryModelResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\preview\Model\ApplicationSummaryModelResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\preview\Model\ApplicationSummaryModelResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\preview\Model\ApplicationSummaryModelResponse';
    ...
    public function getCurrentApplicationRequest(string $contentType = self::contentTypes['getCurrentApplication'][0])
    {
        ...
        $resourcePath = '/preview/retail-media/me';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
