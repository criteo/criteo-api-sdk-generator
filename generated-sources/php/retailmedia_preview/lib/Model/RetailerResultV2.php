...
class RetailerResultV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'campaign_availabilities' => '\criteo\api\retailmedia\preview\Model\CampaignAvailabilityV2[]',
        'name' => 'string'
    ];
    ...
    */
     ...
     *
     * @return \criteo\api\retailmedia\preview\Model\CampaignAvailabilityV2[]|null
     */
     ...
     *
     * @param \criteo\api\retailmedia\preview\Model\CampaignAvailabilityV2[]|null $campaign_availabilities A list of campaign availabilities for the retailer, each showing the budget models available for a specific campaign type and buy type combination
     *
     * @return self
     */
