...
/**
     ...
     * @return \criteo\api\marketingsolutions\v2026_07\Model\GetPortfolioResponse
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2026_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2026_07\Model\GetPortfolioResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function listAdvertisersWithHttpInfo(string $contentType = self::contentTypes['listAdvertisers'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2026_07\Model\GetPortfolioResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2026_07\Model\GetPortfolioResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2026_07\Model\GetPortfolioResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2026_07\Model\GetPortfolioResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2026_07\Model\GetPortfolioResponse',
    ...
    public function listAdvertisersRequest(string $contentType = self::contentTypes['listAdvertisers'][0])
    {
        ...
        $resourcePath = '/2026-07/advertisers/me';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
