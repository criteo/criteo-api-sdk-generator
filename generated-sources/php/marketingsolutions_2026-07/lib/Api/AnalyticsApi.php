...
/**
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2026_07\Model\StatisticsReportQueryMessage $statistics_report_query_message statistics_report_query_message (optional)
     ...
     * /2026-07/statistics/report
     *
     * @param  \criteo\api\marketingsolutions\v2026_07\Model\StatisticsReportQueryMessage $statistics_report_query_message (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAdsetReport'] to see the possible values for this operation
     *
     * @throws \criteo\api\marketingsolutions\v2026_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function getAdsetReportRequest($statistics_report_query_message = null, string $contentType = self::contentTypes['getAdsetReport'][0])
    {
        ...
        $resourcePath = '/2026-07/statistics/report';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2026_07\Model\PlacementsReportQueryMessageListRequest $placements_report_query_message_list_request placements_report_query_message_list_request (optional)
     ...
     * /2026-07/placements/report
     *
     * @param  \criteo\api\marketingsolutions\v2026_07\Model\PlacementsReportQueryMessageListRequest $placements_report_query_message_list_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getPlacementsReport'] to see the possible values for this operation
     *
     * @throws \criteo\api\marketingsolutions\v2026_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function getPlacementsReportRequest($placements_report_query_message_list_request = null, string $contentType = self::contentTypes['getPlacementsReport'][0])
    {
        ...
        $resourcePath = '/2026-07/placements/report';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2026_07\Model\TransactionsReportQueryMessageListRequest $transactions_report_query_message_list_request transactions_report_query_message_list_request (optional)
     ...
     * /2026-07/transactions/report
     *
     * @param  \criteo\api\marketingsolutions\v2026_07\Model\TransactionsReportQueryMessageListRequest $transactions_report_query_message_list_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getTransactionsReport'] to see the possible values for this operation
     *
     * @throws \criteo\api\marketingsolutions\v2026_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function getTransactionsReportRequest($transactions_report_query_message_list_request = null, string $contentType = self::contentTypes['getTransactionsReport'][0])
    {
        ...
        $resourcePath = '/2026-07/transactions/report';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  \criteo\api\marketingsolutions\v2026_07\Model\TransparencyQueryMessage $transparency_query_message The query message. (optional)
     ...
     * @throws \criteo\api\marketingsolutions\v2026_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2026_07\Model\TransparencyReportListResponse
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2026_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2026_07\Model\TransparencyReportListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTransparencyReportWithHttpInfo($advertiser_id, $transparency_query_message = null, string $contentType = self::contentTypes['getTransparencyReport'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2026_07\Model\TransparencyReportListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2026_07\Model\TransparencyReportListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2026_07\Model\TransparencyReportListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2026_07\Model\TransparencyReportListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2026_07\Model\TransparencyReportListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getTransparencyReportRequest($advertiser_id, $transparency_query_message = null, string $contentType = self::contentTypes['getTransparencyReport'][0])
    {
        ...
        $resourcePath = '/2026-07/log-level/advertisers/{advertiser-id}/report';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
