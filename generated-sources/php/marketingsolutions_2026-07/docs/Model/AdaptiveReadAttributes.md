...
**colors** | [**\criteo\api\marketingsolutions\v2026_07\Model\AdaptiveColors**](AdaptiveColors.md) |  | [optional]
...
**image_sets** | [**\criteo\api\marketingsolutions\v2026_07\Model\ImageSet[]**](ImageSet.md) | Multiple image sets, each image set consists of multiple images and a headline text. | [optional]
...
**logos** | [**\criteo\api\marketingsolutions\v2026_07\Model\ImageShape[]**](ImageShape.md) | Logo images uploaded on demostatic.criteo.com when deploying and then static.criteo.net | [optional]
**videos** | [**\criteo\api\marketingsolutions\v2026_07\Model\VideoDetail[]**](VideoDetail.md) | Multiple videos potentially in different shapes. | [optional]
