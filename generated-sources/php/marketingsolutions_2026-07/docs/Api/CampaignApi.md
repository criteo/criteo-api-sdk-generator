# criteo\api\marketingsolutions\v2026_07\CampaignApi
...
```php
createAdSet($create_ad_set_v26_q1_request): \criteo\api\marketingsolutions\v2026_07\Model\ResponseReadAdSetV26Q1
```
...
$apiInstance = new criteo\api\marketingsolutions\v2026_07\Api\CampaignApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$create_ad_set_v26_q1_request = new \criteo\api\marketingsolutions\v2026_07\Model\CreateAdSetV26Q1Request(); // \criteo\api\marketingsolutions\v2026_07\Model\CreateAdSetV26Q1Request | the ad sets to create
...
| ------------- | ------------- | ------------- | ------------- |
| **create_ad_set_v26_q1_request** | [**\criteo\api\marketingsolutions\v2026_07\Model\CreateAdSetV26Q1Request**](../Model/CreateAdSetV26Q1Request.md)| the ad sets to create | |

### Return type

[**\criteo\api\marketingsolutions\v2026_07\Model\ResponseReadAdSetV26Q1**](../Model/ResponseReadAdSetV26Q1.md)
...
```php
createCampaign($create_campaign_request): \criteo\api\marketingsolutions\v2026_07\Model\CampaignV23Q1Response
```
...
$create_campaign_request = new \criteo\api\marketingsolutions\v2026_07\Model\CreateCampaignRequest(); // \criteo\api\marketingsolutions\v2026_07\Model\CreateCampaignRequest | the campaigns to create
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **create_campaign_request** | [**\criteo\api\marketingsolutions\v2026_07\Model\CreateCampaignRequest**](../Model/CreateCampaignRequest.md)| the campaigns to create | |

### Return type

[**\criteo\api\marketingsolutions\v2026_07\Model\CampaignV23Q1Response**](../Model/CampaignV23Q1Response.md)
...
```php
createMarketplaceSellerBudgets($create_seller_budget_mapi_message): \criteo\api\marketingsolutions\v2026_07\Model\SellerBudgetMessage[]
```
...
$create_seller_budget_mapi_message = array(new \criteo\api\marketingsolutions\v2026_07\Model\CreateSellerBudgetMapiMessage()); // \criteo\api\marketingsolutions\v2026_07\Model\CreateSellerBudgetMapiMessage[] | 
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **create_seller_budget_mapi_message** | [**\criteo\api\marketingsolutions\v2026_07\Model\CreateSellerBudgetMapiMessage[]**](../Model/CreateSellerBudgetMapiMessage.md)|  | |

### Return type

[**\criteo\api\marketingsolutions\v2026_07\Model\SellerBudgetMessage[]**](../Model/SellerBudgetMessage.md)
...
```php
createMarketplaceSellerCampaignsBySeller($seller_id, $create_seller_campaign_message_mapi): \criteo\api\marketingsolutions\v2026_07\Model\SellerCampaignMessage
```
...
$create_seller_campaign_message_mapi = new \criteo\api\marketingsolutions\v2026_07\Model\CreateSellerCampaignMessageMapi(); // \criteo\api\marketingsolutions\v2026_07\Model\CreateSellerCampaignMessageMapi | Supply the campaign Id and bid to create the mapping
...
| **create_seller_campaign_message_mapi** | [**\criteo\api\marketingsolutions\v2026_07\Model\CreateSellerCampaignMessageMapi**](../Model/CreateSellerCampaignMessageMapi.md)| Supply the campaign Id and bid to create the mapping | |

### Return type

[**\criteo\api\marketingsolutions\v2026_07\Model\SellerCampaignMessage**](../Model/SellerCampaignMessage.md)
...
```php
getAdSet($ad_set_id): \criteo\api\marketingsolutions\v2026_07\Model\ResponseReadAdSetV26Q1
```
...
```php
getAdSetCategoryBids($ad_set_id): \criteo\api\marketingsolutions\v2026_07\Model\AdSetCategoryBidListResponse
```
...
[**\criteo\api\marketingsolutions\v2026_07\Model\AdSetCategoryBidListResponse**](../Model/AdSetCategoryBidListResponse.md)
...
```php
getCampaign($campaign_id): \criteo\api\marketingsolutions\v2026_07\Model\CampaignV23Q1Response
```
...
```php
getDisplayMultipliers($ad_set_id): \criteo\api\marketingsolutions\v2026_07\Model\AdSetDisplayMultiplierListResponse
```
...
[**\criteo\api\marketingsolutions\v2026_07\Model\AdSetDisplayMultiplierListResponse**](../Model/AdSetDisplayMultiplierListResponse.md)
...
```php
getMarketplaceAdSetsByAdvertiser($advertiser_id): \criteo\api\marketingsolutions\v2026_07\Model\AdvertiserAdsetMessage[]
```
...
[**\criteo\api\marketingsolutions\v2026_07\Model\AdvertiserAdsetMessage[]**](../Model/AdvertiserAdsetMessage.md)
...
```php
getMarketplaceAdvertiser($advertiser_id): \criteo\api\marketingsolutions\v2026_07\Model\AdvertiserInfoMessage
```
...
[**\criteo\api\marketingsolutions\v2026_07\Model\AdvertiserInfoMessage**](../Model/AdvertiserInfoMessage.md)
...
```php
getMarketplaceAdvertiserPreviewLimits(): \criteo\api\marketingsolutions\v2026_07\Model\AdvertiserQuotaMessage[]
```
...
[**\criteo\api\marketingsolutions\v2026_07\Model\AdvertiserQuotaMessage[]**](../Model/AdvertiserQuotaMessage.md)
...
```php
getMarketplaceAdvertisers(): \criteo\api\marketingsolutions\v2026_07\Model\AdvertiserInfoMessage[]
```
...
```php
getMarketplaceBudgetsByAdvertiser($advertiser_id, $budget_id, $end_after_date, $seller_id, $start_before_date, $status, $type, $with_balance, $with_spend): \criteo\api\marketingsolutions\v2026_07\Model\SellerBudgetMessage[]
```
...
```php
getMarketplaceBudgetsBySeller($seller_id, $campaign_id, $end_after_date, $start_before_date, $status, $type, $with_balance, $with_spend): \criteo\api\marketingsolutions\v2026_07\Model\SellerBudgetMessage[]
```
...
```php
getMarketplaceBudgetsBySellerCampaign($seller_campaign_id, $end_after_date, $start_before_date, $status, $type, $with_balance, $with_spend): \criteo\api\marketingsolutions\v2026_07\Model\SellerBudgetMessage[]
```
...
```php
getMarketplaceCampaignsByAdvertiser($advertiser_id): \criteo\api\marketingsolutions\v2026_07\Model\AdvertiserCampaignMessage[]
```
...
[**\criteo\api\marketingsolutions\v2026_07\Model\AdvertiserCampaignMessage[]**](../Model/AdvertiserCampaignMessage.md)
...
```php
getMarketplaceCampaignsStats($advertiser_id, $campaign_id, $click_attribution_policy, $count, $end_date, $interval_size, $start_date, $time_zone_id): \criteo\api\marketingsolutions\v2026_07\Model\StatsReportMessage
```
...
[**\criteo\api\marketingsolutions\v2026_07\Model\StatsReportMessage**](../Model/StatsReportMessage.md)
...
```php
getMarketplaceSeller($seller_id): \criteo\api\marketingsolutions\v2026_07\Model\SellerBase
```
...
[**\criteo\api\marketingsolutions\v2026_07\Model\SellerBase**](../Model/SellerBase.md)
...
```php
getMarketplaceSellerBudget($budget_id): \criteo\api\marketingsolutions\v2026_07\Model\SellerBudgetMessage
```
...
```php
getMarketplaceSellerBudgets($advertiser_id, $campaign_id, $end_after_date, $seller_id, $start_before_date, $status, $type, $with_balance, $with_spend): \criteo\api\marketingsolutions\v2026_07\Model\SellerBudgetMessage[]
```
...
```php
getMarketplaceSellerCampaign($seller_campaign_id): \criteo\api\marketingsolutions\v2026_07\Model\SellerCampaignMessage
```
...
```php
getMarketplaceSellerCampaigns($advertiser_id, $budget_status, $campaign_id, $seller_id, $seller_status): \criteo\api\marketingsolutions\v2026_07\Model\SellerCampaignMessage[]
```
...
```php
getMarketplaceSellerCampaignsByAdvertiser($advertiser_id): \criteo\api\marketingsolutions\v2026_07\Model\SellerCampaignMessage[]
```
...
```php
getMarketplaceSellerCampaignsBySeller($seller_id, $budget_status, $campaign_id, $seller_status): \criteo\api\marketingsolutions\v2026_07\Model\SellerCampaignMessage[]
```
...
```php
getMarketplaceSellerCampaignsStats($advertiser_id, $campaign_id, $click_attribution_policy, $count, $end_date, $interval_size, $seller_id, $start_date, $time_zone_id): \criteo\api\marketingsolutions\v2026_07\Model\StatsReportMessage
```
...
```php
getMarketplaceSellers($advertiser_id, $campaign_id, $seller_name, $seller_status, $with_budget_status, $with_products): \criteo\api\marketingsolutions\v2026_07\Model\SellerBase[]
```
...
```php
getMarketplaceSellersByAdvertiser($advertiser_id, $request_body, $partner_id): \criteo\api\marketingsolutions\v2026_07\Model\SellerBase[]
```
...
```php
getMarketplaceSellersStats($advertiser_id, $click_attribution_policy, $count, $end_date, $interval_size, $seller_id, $start_date, $time_zone_id): \criteo\api\marketingsolutions\v2026_07\Model\StatsReportMessage
```
...
```php
patchAdSetCategoryBids($ad_set_id, $patch_ad_set_category_bid_list_request): \criteo\api\marketingsolutions\v2026_07\Model\PatchAdSetCategoryBidResultListResponse
```
...
$ad_set_id = 'ad_set_id_example'; // string | Id of the Ad Set
$patch_ad_set_category_bid_list_request = new \criteo\api\marketingsolutions\v2026_07\Model\PatchAdSetCategoryBidListRequest(); // \criteo\api\marketingsolutions\v2026_07\Model\PatchAdSetCategoryBidListRequest | Collection of category bids to update
...
| ------------- | ------------- | ------------- | ------------- |
| **ad_set_id** | **string**| Id of the Ad Set | |
| **patch_ad_set_category_bid_list_request** | [**\criteo\api\marketingsolutions\v2026_07\Model\PatchAdSetCategoryBidListRequest**](../Model/PatchAdSetCategoryBidListRequest.md)| Collection of category bids to update | |

### Return type

[**\criteo\api\marketingsolutions\v2026_07\Model\PatchAdSetCategoryBidResultListResponse**](../Model/PatchAdSetCategoryBidResultListResponse.md)
...
```php
patchAdSets($requests_patch_ad_set_v26_q1): \criteo\api\marketingsolutions\v2026_07\Model\ResponsesAdSetIdV26Q1
```
...
$requests_patch_ad_set_v26_q1 = new \criteo\api\marketingsolutions\v2026_07\Model\RequestsPatchAdSetV26Q1(); // \criteo\api\marketingsolutions\v2026_07\Model\RequestsPatchAdSetV26Q1 | List of adsets to patch.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **requests_patch_ad_set_v26_q1** | [**\criteo\api\marketingsolutions\v2026_07\Model\RequestsPatchAdSetV26Q1**](../Model/RequestsPatchAdSetV26Q1.md)| List of adsets to patch. | |

### Return type

[**\criteo\api\marketingsolutions\v2026_07\Model\ResponsesAdSetIdV26Q1**](../Model/ResponsesAdSetIdV26Q1.md)
...
```php
patchCampaigns($patch_campaign_list_request): \criteo\api\marketingsolutions\v2026_07\Model\PatchResultCampaignListResponse
```
...
$patch_campaign_list_request = new \criteo\api\marketingsolutions\v2026_07\Model\PatchCampaignListRequest(); // \criteo\api\marketingsolutions\v2026_07\Model\PatchCampaignListRequest | List of campaigns to patch.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **patch_campaign_list_request** | [**\criteo\api\marketingsolutions\v2026_07\Model\PatchCampaignListRequest**](../Model/PatchCampaignListRequest.md)| List of campaigns to patch. | |

### Return type

[**\criteo\api\marketingsolutions\v2026_07\Model\PatchResultCampaignListResponse**](../Model/PatchResultCampaignListResponse.md)
...
```php
patchDisplayMultipliers($ad_set_id, $patch_ad_set_display_multiplier_list_request): \criteo\api\marketingsolutions\v2026_07\Model\PatchAdSetDisplayMultiplierResultListResponse
```
...
$ad_set_id = 'ad_set_id_example'; // string | Id of the Ad Set
$patch_ad_set_display_multiplier_list_request = new \criteo\api\marketingsolutions\v2026_07\Model\PatchAdSetDisplayMultiplierListRequest(); // \criteo\api\marketingsolutions\v2026_07\Model\PatchAdSetDisplayMultiplierListRequest | List of display multiplier values to change
...
| ------------- | ------------- | ------------- | ------------- |
| **ad_set_id** | **string**| Id of the Ad Set | |
| **patch_ad_set_display_multiplier_list_request** | [**\criteo\api\marketingsolutions\v2026_07\Model\PatchAdSetDisplayMultiplierListRequest**](../Model/PatchAdSetDisplayMultiplierListRequest.md)| List of display multiplier values to change | |

### Return type

[**\criteo\api\marketingsolutions\v2026_07\Model\PatchAdSetDisplayMultiplierResultListResponse**](../Model/PatchAdSetDisplayMultiplierResultListResponse.md)
...
```php
searchAdSets($ad_set_search_request_v26_q1): \criteo\api\marketingsolutions\v2026_07\Model\ResponsesReadAdSetV26Q1
```
...
$ad_set_search_request_v26_q1 = new \criteo\api\marketingsolutions\v2026_07\Model\AdSetSearchRequestV26Q1(); // \criteo\api\marketingsolutions\v2026_07\Model\AdSetSearchRequestV26Q1
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ad_set_search_request_v26_q1** | [**\criteo\api\marketingsolutions\v2026_07\Model\AdSetSearchRequestV26Q1**](../Model/AdSetSearchRequestV26Q1.md)|  | [optional] |

### Return type

[**\criteo\api\marketingsolutions\v2026_07\Model\ResponsesReadAdSetV26Q1**](../Model/ResponsesReadAdSetV26Q1.md)
...
```php
searchCampaigns($campaign_search_request_v23_q1): \criteo\api\marketingsolutions\v2026_07\Model\CampaignV23Q1ListResponse
```
...
$campaign_search_request_v23_q1 = new \criteo\api\marketingsolutions\v2026_07\Model\CampaignSearchRequestV23Q1(); // \criteo\api\marketingsolutions\v2026_07\Model\CampaignSearchRequestV23Q1 | Filters for searching for campaigns
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **campaign_search_request_v23_q1** | [**\criteo\api\marketingsolutions\v2026_07\Model\CampaignSearchRequestV23Q1**](../Model/CampaignSearchRequestV23Q1.md)| Filters for searching for campaigns | [optional] |

### Return type

[**\criteo\api\marketingsolutions\v2026_07\Model\CampaignV23Q1ListResponse**](../Model/CampaignV23Q1ListResponse.md)
...
```php
startAdSets($requests_ad_set_id): \criteo\api\marketingsolutions\v2026_07\Model\ResponsesAdSetId
```
...
$requests_ad_set_id = new \criteo\api\marketingsolutions\v2026_07\Model\RequestsAdSetId(); // \criteo\api\marketingsolutions\v2026_07\Model\RequestsAdSetId | All the ad sets to start
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **requests_ad_set_id** | [**\criteo\api\marketingsolutions\v2026_07\Model\RequestsAdSetId**](../Model/RequestsAdSetId.md)| All the ad sets to start | [optional] |

### Return type

[**\criteo\api\marketingsolutions\v2026_07\Model\ResponsesAdSetId**](../Model/ResponsesAdSetId.md)
...
```php
stopAdSets($requests_ad_set_id): \criteo\api\marketingsolutions\v2026_07\Model\ResponsesAdSetId
```
...
$requests_ad_set_id = new \criteo\api\marketingsolutions\v2026_07\Model\RequestsAdSetId(); // \criteo\api\marketingsolutions\v2026_07\Model\RequestsAdSetId | All the ad sets to stop
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **requests_ad_set_id** | [**\criteo\api\marketingsolutions\v2026_07\Model\RequestsAdSetId**](../Model/RequestsAdSetId.md)| All the ad sets to stop | [optional] |
...
```php
updateAdSetAudience($ad_set_id, $ad_set_audience_link_input_entity_v1): \criteo\api\marketingsolutions\v2026_07\Model\AdSetAudienceLinkEntityV1Response
```
...
$ad_set_audience_link_input_entity_v1 = new \criteo\api\marketingsolutions\v2026_07\Model\AdSetAudienceLinkInputEntityV1(); // \criteo\api\marketingsolutions\v2026_07\Model\AdSetAudienceLinkInputEntityV1 | Ad set-Audience update request.
...
| **ad_set_audience_link_input_entity_v1** | [**\criteo\api\marketingsolutions\v2026_07\Model\AdSetAudienceLinkInputEntityV1**](../Model/AdSetAudienceLinkInputEntityV1.md)| Ad set-Audience update request. | |

### Return type

[**\criteo\api\marketingsolutions\v2026_07\Model\AdSetAudienceLinkEntityV1Response**](../Model/AdSetAudienceLinkEntityV1Response.md)
...
```php
updateMarketplaceSellerBudget($budget_id, $update_seller_budget_message_base): \criteo\api\marketingsolutions\v2026_07\Model\SellerBudgetMessage
```
...
$budget_id = 'budget_id_example'; // string | Id of the budget
$update_seller_budget_message_base = new \criteo\api\marketingsolutions\v2026_07\Model\UpdateSellerBudgetMessageBase(); // \criteo\api\marketingsolutions\v2026_07\Model\UpdateSellerBudgetMessageBase | 
...
| ------------- | ------------- | ------------- | ------------- |
| **budget_id** | **string**| Id of the budget | |
| **update_seller_budget_message_base** | [**\criteo\api\marketingsolutions\v2026_07\Model\UpdateSellerBudgetMessageBase**](../Model/UpdateSellerBudgetMessageBase.md)|  | |
...
```php
updateMarketplaceSellerBudgets($update_seller_budget_message): \criteo\api\marketingsolutions\v2026_07\Model\SellerBudgetMessage[]
```
...
$update_seller_budget_message = array(new \criteo\api\marketingsolutions\v2026_07\Model\UpdateSellerBudgetMessage()); // \criteo\api\marketingsolutions\v2026_07\Model\UpdateSellerBudgetMessage[] | 
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **update_seller_budget_message** | [**\criteo\api\marketingsolutions\v2026_07\Model\UpdateSellerBudgetMessage[]**](../Model/UpdateSellerBudgetMessage.md)|  | |
...
```php
updateMarketplaceSellerCampaign($seller_campaign_id, $bid): \criteo\api\marketingsolutions\v2026_07\Model\SellerCampaignMessage
```
...
```php
updateMarketplaceSellerCampaigns($seller_campaign_update): \criteo\api\marketingsolutions\v2026_07\Model\SellerCampaignMessage[]
```
...
$seller_campaign_update = array(new \criteo\api\marketingsolutions\v2026_07\Model\SellerCampaignUpdate()); // \criteo\api\marketingsolutions\v2026_07\Model\SellerCampaignUpdate[] | 
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **seller_campaign_update** | [**\criteo\api\marketingsolutions\v2026_07\Model\SellerCampaignUpdate[]**](../Model/SellerCampaignUpdate.md)|  | |
