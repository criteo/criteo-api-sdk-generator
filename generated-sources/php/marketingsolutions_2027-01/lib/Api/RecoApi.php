...
/**
     ...
     * @param  \criteo\api\marketingsolutions\v2027_01\Model\ValueResourceInputOfBoostingConfigurationRequest $value_resource_input_of_boosting_configuration_request value_resource_input_of_boosting_configuration_request (optional)
     ...
     * @return \criteo\api\marketingsolutions\v2027_01\Model\ValueResourceOutcomeOfBoostedAdProductSet|\criteo\api\marketingsolutions\v2027_01\Model\ValueResourceOutcomeOfBoostedAdProductSet
     */
     ...
     * @param  string $ad_id ID of the ad (required)
     * @param  string $product_set_id ID of the product set (required)
     * @param  \criteo\api\marketingsolutions\v2027_01\Model\ValueResourceInputOfBoostingConfigurationRequest $value_resource_input_of_boosting_configuration_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createBoostedAdAssociation'] to see the possible values for this operation
     *
     * @throws \criteo\api\marketingsolutions\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2027_01\Model\ValueResourceOutcomeOfBoostedAdProductSet|\criteo\api\marketingsolutions\v2027_01\Model\ValueResourceOutcomeOfBoostedAdProductSet, HTTP status code, HTTP response headers (array of strings)
     */
    public function createBoostedAdAssociationWithHttpInfo($ad_id, $product_set_id, $value_resource_input_of_boosting_configuration_request = null, string $contentType = self::contentTypes['createBoostedAdAssociation'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2027_01\Model\ValueResourceOutcomeOfBoostedAdProductSet' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2027_01\Model\ValueResourceOutcomeOfBoostedAdProductSet' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2027_01\Model\ValueResourceOutcomeOfBoostedAdProductSet', []),
            ...
            $returnType = '\criteo\api\marketingsolutions\v2027_01\Model\ValueResourceOutcomeOfBoostedAdProductSet';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2027_01\Model\ValueResourceOutcomeOfBoostedAdProductSet',
    ...
    public function createBoostedAdAssociationRequest($ad_id, $product_set_id, $value_resource_input_of_boosting_configuration_request = null, string $contentType = self::contentTypes['createBoostedAdAssociation'][0])
    {
        ...
        $resourcePath = '/2027-01/marketing-solutions/ads/{ad-id}/product-boost/{product-set-id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2027_01\Model\ValueResourceInputOfCreateProductSetRequest $value_resource_input_of_create_product_set_request value_resource_input_of_create_product_set_request (required)
     ...
     * @throws \criteo\api\marketingsolutions\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfProductSet
     */
     ...
     * /2027-01/marketing-solutions/product-sets
     *
     * @param  \criteo\api\marketingsolutions\v2027_01\Model\ValueResourceInputOfCreateProductSetRequest $value_resource_input_of_create_product_set_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createProductSet'] to see the possible values for this operation
     *
     * @throws \criteo\api\marketingsolutions\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfProductSet, HTTP status code, HTTP response headers (array of strings)
     */
    public function createProductSetWithHttpInfo($value_resource_input_of_create_product_set_request, string $contentType = self::contentTypes['createProductSet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfProductSet' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfProductSet' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfProductSet', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfProductSet';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfProductSet',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function createProductSetRequest($value_resource_input_of_create_product_set_request, string $contentType = self::contentTypes['createProductSet'][0])
    {
        ...
        $resourcePath = '/2027-01/marketing-solutions/product-sets';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\marketingsolutions\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2027_01\Model\ValueResourceOutcomeOfBoostedAdProductSet
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2027_01\Model\ValueResourceOutcomeOfBoostedAdProductSet, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2027_01\Model\ValueResourceOutcomeOfProductFilterConfig
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2027_01\Model\ValueResourceOutcomeOfProductFilterConfig, HTTP status code, HTTP response headers (array of strings)
     */
    public function disableProductFilteringWithHttpInfo($ad_id, string $contentType = self::contentTypes['disableProductFiltering'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2027_01\Model\ValueResourceOutcomeOfProductFilterConfig' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2027_01\Model\ValueResourceOutcomeOfProductFilterConfig' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2027_01\Model\ValueResourceOutcomeOfProductFilterConfig', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2027_01\Model\ValueResourceOutcomeOfProductFilterConfig';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2027_01\Model\ValueResourceOutcomeOfProductFilterConfig',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function disableProductFilteringRequest($ad_id, string $contentType = self::contentTypes['disableProductFiltering'][0])
    {
        ...
        $resourcePath = '/2027-01/marketing-solutions/ads/{ad-id}/product-filter';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $ad_id ID of the ad (required)
     * @param  \criteo\api\marketingsolutions\v2027_01\Model\ValueResourceInputOfCreateProductFilterRequest $value_resource_input_of_create_product_filter_request value_resource_input_of_create_product_filter_request (optional)
     ...
     *
     * @param  string $ad_id ID of the ad (required)
     * @param  \criteo\api\marketingsolutions\v2027_01\Model\ValueResourceInputOfCreateProductFilterRequest $value_resource_input_of_create_product_filter_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['enableProductFiltering'] to see the possible values for this operation
     *
     * @throws \criteo\api\marketingsolutions\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \criteo\api\marketingsolutions\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2027_01\Model\ValueResourceCollectionOutcomeOfBoostedAdProductSet
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2027_01\Model\ValueResourceCollectionOutcomeOfBoostedAdProductSet, HTTP status code, HTTP response headers (array of strings)
     */
    public function fetchBoostedAdAssociationByPartnerIdWithHttpInfo($dataset_id, $client_type = null, string $contentType = self::contentTypes['fetchBoostedAdAssociationByPartnerId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2027_01\Model\ValueResourceCollectionOutcomeOfBoostedAdProductSet' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2027_01\Model\ValueResourceCollectionOutcomeOfBoostedAdProductSet' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2027_01\Model\ValueResourceCollectionOutcomeOfBoostedAdProductSet', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2027_01\Model\ValueResourceCollectionOutcomeOfBoostedAdProductSet';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2027_01\Model\ValueResourceCollectionOutcomeOfBoostedAdProductSet',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function fetchBoostedAdAssociationByPartnerIdRequest($dataset_id, $client_type = null, string $contentType = self::contentTypes['fetchBoostedAdAssociationByPartnerId'][0])
    {
        ...
        $resourcePath = '/2027-01/marketing-solutions/dataset/{dataset-id}/product-boost';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function fetchBoostedAdAssociationsRequest($ad_id, string $contentType = self::contentTypes['fetchBoostedAdAssociations'][0])
    {
        ...
        $resourcePath = '/2027-01/marketing-solutions/ads/{ad-id}/product-boost';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\marketingsolutions\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2027_01\Model\ValueResourceCollectionOutcomeOfProductFilterConfig
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2027_01\Model\ValueResourceCollectionOutcomeOfProductFilterConfig, HTTP status code, HTTP response headers (array of strings)
     */
    public function fetchProductFilteringUsagesWithHttpInfo($product_set_id, string $contentType = self::contentTypes['fetchProductFilteringUsages'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2027_01\Model\ValueResourceCollectionOutcomeOfProductFilterConfig' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2027_01\Model\ValueResourceCollectionOutcomeOfProductFilterConfig' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2027_01\Model\ValueResourceCollectionOutcomeOfProductFilterConfig', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2027_01\Model\ValueResourceCollectionOutcomeOfProductFilterConfig';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2027_01\Model\ValueResourceCollectionOutcomeOfProductFilterConfig',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function fetchProductFilteringUsagesRequest($product_set_id, string $contentType = self::contentTypes['fetchProductFilteringUsages'][0])
    {
        ...
        $resourcePath = '/2027-01/marketing-solutions/product-sets/{product-set-id}/product-filters';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function fetchProductSetRequest($product_set_id, string $contentType = self::contentTypes['fetchProductSet'][0])
    {
        ...
        $resourcePath = '/2027-01/marketing-solutions/product-sets/{product-set-id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\marketingsolutions\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2027_01\Model\ResourceCollectionOutcomeOfProductSet
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2027_01\Model\ResourceCollectionOutcomeOfProductSet, HTTP status code, HTTP response headers (array of strings)
     */
    public function fetchProductSetsWithHttpInfo($dataset_id, string $contentType = self::contentTypes['fetchProductSets'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2027_01\Model\ResourceCollectionOutcomeOfProductSet' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2027_01\Model\ResourceCollectionOutcomeOfProductSet' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2027_01\Model\ResourceCollectionOutcomeOfProductSet', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2027_01\Model\ResourceCollectionOutcomeOfProductSet';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2027_01\Model\ResourceCollectionOutcomeOfProductSet',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function fetchProductSetsRequest($dataset_id, string $contentType = self::contentTypes['fetchProductSets'][0])
    {
        ...
        $resourcePath = '/2027-01/marketing-solutions/product-sets/dataset/{dataset-id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $product_set_id ID of the product set (required)
     * @param  \criteo\api\marketingsolutions\v2027_01\Model\ValueResourceInputOfPatchProductSetRequest $value_resource_input_of_patch_product_set_request value_resource_input_of_patch_product_set_request (required)
     ...
     *
     * @param  string $product_set_id ID of the product set (required)
     * @param  \criteo\api\marketingsolutions\v2027_01\Model\ValueResourceInputOfPatchProductSetRequest $value_resource_input_of_patch_product_set_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['patchProductSet'] to see the possible values for this operation
     *
     * @throws \criteo\api\marketingsolutions\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \criteo\api\marketingsolutions\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2027_01\Model\Outcome
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2027_01\Model\Outcome, HTTP status code, HTTP response headers (array of strings)
     */
    public function removeProductSetWithHttpInfo($product_set_id, string $contentType = self::contentTypes['removeProductSet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 204:
                    if ('\criteo\api\marketingsolutions\v2027_01\Model\Outcome' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2027_01\Model\Outcome' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2027_01\Model\Outcome', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2027_01\Model\Outcome';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 204:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2027_01\Model\Outcome',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
