...
/**
     ...
     * @param  \criteo\api\marketingsolutions\v2027_01\Model\ResourceInputOfAdWrite $resource_input_of_ad_write resource_input_of_ad_write (required)
     ...
     * @return \criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfAd
     */
     ...
     *
     * @param  string $advertiser_id The advertiser identifier. (required)
     * @param  \criteo\api\marketingsolutions\v2027_01\Model\ResourceInputOfAdWrite $resource_input_of_ad_write (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createAdvertiserAd'] to see the possible values for this operation
     *
     * @throws \criteo\api\marketingsolutions\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfAd, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAdvertiserAdWithHttpInfo($advertiser_id, $resource_input_of_ad_write, string $contentType = self::contentTypes['createAdvertiserAd'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfAd' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfAd' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfAd', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfAd';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfAd',
    ...
    public function createAdvertiserAdRequest($advertiser_id, $resource_input_of_ad_write, string $contentType = self::contentTypes['createAdvertiserAd'][0])
    {
        ...
        $resourcePath = '/2027-01/marketing-solutions/advertisers/{advertiser-id}/ads';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $advertiser_id The advertiser identifier. (required)
     * @param  \criteo\api\marketingsolutions\v2027_01\Model\ResourceInputOfCreateCoupon $resource_input_of_create_coupon resource_input_of_create_coupon (required)
     ...
     * @throws \criteo\api\marketingsolutions\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfCoupon
     */
     ...
     *
     * @param  string $advertiser_id The advertiser identifier. (required)
     * @param  \criteo\api\marketingsolutions\v2027_01\Model\ResourceInputOfCreateCoupon $resource_input_of_create_coupon (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createAdvertiserCoupon'] to see the possible values for this operation
     *
     * @throws \criteo\api\marketingsolutions\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfCoupon, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAdvertiserCouponWithHttpInfo($advertiser_id, $resource_input_of_create_coupon, string $contentType = self::contentTypes['createAdvertiserCoupon'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfCoupon' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfCoupon' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfCoupon', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfCoupon';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfCoupon',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function createAdvertiserCouponRequest($advertiser_id, $resource_input_of_create_coupon, string $contentType = self::contentTypes['createAdvertiserCoupon'][0])
    {
        ...
        $resourcePath = '/2027-01/marketing-solutions/advertisers/{advertiser-id}/coupons';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $advertiser_id The advertiser identifier. (required)
     * @param  \criteo\api\marketingsolutions\v2027_01\Model\ResourceInputOfCreativeWrite $resource_input_of_creative_write resource_input_of_creative_write (required)
     ...
     * @throws \criteo\api\marketingsolutions\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfCreative
     */
     ...
     *
     * @param  string $advertiser_id The advertiser identifier. (required)
     * @param  \criteo\api\marketingsolutions\v2027_01\Model\ResourceInputOfCreativeWrite $resource_input_of_creative_write (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createAdvertiserCreative'] to see the possible values for this operation
     *
     * @throws \criteo\api\marketingsolutions\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfCreative, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAdvertiserCreativeWithHttpInfo($advertiser_id, $resource_input_of_creative_write, string $contentType = self::contentTypes['createAdvertiserCreative'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfCreative' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfCreative' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfCreative', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfCreative';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfCreative',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function createAdvertiserCreativeRequest($advertiser_id, $resource_input_of_creative_write, string $contentType = self::contentTypes['createAdvertiserCreative'][0])
    {
        ...
        $resourcePath = '/2027-01/marketing-solutions/advertisers/{advertiser-id}/creatives';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function deleteAdRequest($id, string $contentType = self::contentTypes['deleteAd'][0])
    {
        ...
        $resourcePath = '/2027-01/marketing-solutions/ads/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function deleteAdvertiserCouponRequest($advertiser_id, $id, string $contentType = self::contentTypes['deleteAdvertiserCoupon'][0])
    {
        ...
        $resourcePath = '/2027-01/marketing-solutions/advertisers/{advertiser-id}/coupons/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function deleteCreativeRequest($id, string $contentType = self::contentTypes['deleteCreative'][0])
    {
        ...
        $resourcePath = '/2027-01/marketing-solutions/creatives/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  \criteo\api\marketingsolutions\v2027_01\Model\ResourceInputOfUpdateCoupon $resource_input_of_update_coupon resource_input_of_update_coupon (required)
     ...
     * @param  string $advertiser_id The advertiser identifier. (required)
     * @param  string $id The Coupon identifier to edit. (required)
     * @param  \criteo\api\marketingsolutions\v2027_01\Model\ResourceInputOfUpdateCoupon $resource_input_of_update_coupon (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['editAdvertiserCoupon'] to see the possible values for this operation
     *
     * @throws \criteo\api\marketingsolutions\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function generateCreativePreviewRequest($id, $height = null, $width = null, string $contentType = self::contentTypes['generateCreativePreview'][0])
    {
        ...
        $resourcePath = '/2027-01/marketing-solutions/creatives/{id}/preview';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\marketingsolutions\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2027_01\Model\ResourceCollectionOutcomeOfAd
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2027_01\Model\ResourceCollectionOutcomeOfAd, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAdvertiserAdsWithHttpInfo($advertiser_id, $limit = null, $offset = null, string $contentType = self::contentTypes['getAdvertiserAds'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2027_01\Model\ResourceCollectionOutcomeOfAd' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2027_01\Model\ResourceCollectionOutcomeOfAd' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2027_01\Model\ResourceCollectionOutcomeOfAd', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2027_01\Model\ResourceCollectionOutcomeOfAd';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2027_01\Model\ResourceCollectionOutcomeOfAd',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getAdvertiserCouponPreviewRequest($advertiser_id, $id, $height = null, $width = null, string $contentType = self::contentTypes['getAdvertiserCouponPreview'][0])
    {
        ...
        $resourcePath = '/2027-01/marketing-solutions/advertisers/{advertiser-id}/coupons/{id}/preview';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\marketingsolutions\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfCouponSupportedSizes
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfCouponSupportedSizes, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAdvertiserCouponSupportedSizesWithHttpInfo($advertiser_id, $ad_set_id = null, string $contentType = self::contentTypes['getAdvertiserCouponSupportedSizes'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfCouponSupportedSizes' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfCouponSupportedSizes' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfCouponSupportedSizes', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfCouponSupportedSizes';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2027_01\Model\ResourceOutcomeOfCouponSupportedSizes',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getAdvertiserCouponSupportedSizesRequest($advertiser_id, $ad_set_id = null, string $contentType = self::contentTypes['getAdvertiserCouponSupportedSizes'][0])
    {
        ...
        $resourcePath = '/2027-01/marketing-solutions/advertisers/{advertiser-id}/coupons-supported-sizes';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\marketingsolutions\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2027_01\Model\ResourceCollectionOutcomeOfCoupon
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2027_01\Model\ResourceCollectionOutcomeOfCoupon, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAdvertiserCouponsWithHttpInfo($advertiser_id, $limit = null, $offset = null, string $contentType = self::contentTypes['getAdvertiserCoupons'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2027_01\Model\ResourceCollectionOutcomeOfCoupon' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2027_01\Model\ResourceCollectionOutcomeOfCoupon' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2027_01\Model\ResourceCollectionOutcomeOfCoupon', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2027_01\Model\ResourceCollectionOutcomeOfCoupon';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2027_01\Model\ResourceCollectionOutcomeOfCoupon',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \criteo\api\marketingsolutions\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2027_01\Model\ResourceCollectionOutcomeOfCreativeRead
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2027_01\Model\ResourceCollectionOutcomeOfCreativeRead, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAdvertiserCreativesWithHttpInfo($advertiser_id, $limit = null, $offset = null, string $contentType = self::contentTypes['getAdvertiserCreatives'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2027_01\Model\ResourceCollectionOutcomeOfCreativeRead' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2027_01\Model\ResourceCollectionOutcomeOfCreativeRead' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2027_01\Model\ResourceCollectionOutcomeOfCreativeRead', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2027_01\Model\ResourceCollectionOutcomeOfCreativeRead';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2027_01\Model\ResourceCollectionOutcomeOfCreativeRead',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
