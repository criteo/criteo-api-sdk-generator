<?php
namespace criteo\api\commercegrid\experimental;

use criteo\api\commercegrid\experimental\Api\GatewayApi;
use criteo\api\commercegrid\experimental\ClientCredentialsClient;
use criteo\api\commercegrid\experimental\ApiException;
use criteo\api\commercegrid\experimental\ObjectSerializer;
use criteo\api\commercegrid\experimental\test\ExampleApplication;
...
class GatewayApiTest extends TestCase
{
    ...
    function __construct()
    {
        ...
        $this->clientId = $_SERVER["COMMERCEGRID_TEST_CLIENT_ID"];
        $this->clientSecret = $_SERVER["COMMERCEGRID_TEST_CLIENT_SECRET"];
        $this->applicationId = (int) $_SERVER["COMMERCEGRID_TEST_APPLICATION_ID"];
    }
        ...
        $this->assertThrows(ApiException::class,
            ...
            function($exception) {
                $data = ObjectSerializer::deserialize(
                    ...
                    '\criteo\api\commercegrid\experimental\Model\ApplicationSummaryModelResponse',
