...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/0.0.260803/PHP';
    ...
    {
        $report  = 'PHP SDK (criteo\api\commercegrid\experimental) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: Experimental' . PHP_EOL;
        $report .= '    SDK Package Version: 0.0.260803' . PHP_EOL;
