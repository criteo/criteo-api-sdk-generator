...
/**
     ...
     * @param  \criteo\api\retailmedia\v2027_01\Model\BatchStoreInventoryDeleteRequest $batch_store_inventory_delete_request batch_store_inventory_delete_request (required)
     ...
     *
     * @param  string $merchant_id Identifies the merchant, can also be called partnerId (required)
     * @param  \criteo\api\retailmedia\v2027_01\Model\BatchStoreInventoryDeleteRequest $batch_store_inventory_delete_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteStoreInventoryPerMerchantId'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function deleteStoreInventoryPerMerchantIdRequest($merchant_id, $batch_store_inventory_delete_request, string $contentType = self::contentTypes['deleteStoreInventoryPerMerchantId'][0])
    {
        ...
        $resourcePath = '/2027-01/retail-media/catalog/merchants/{merchantId}/store-inventory/delete';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $merchant_id Identifies the merchant, can also be called partnerId (required)
     * @param  \criteo\api\retailmedia\v2027_01\Model\BatchStoreInventoryRequest $batch_store_inventory_request batch_store_inventory_request (required)
     ...
     *
     * @param  string $merchant_id Identifies the merchant, can also be called partnerId (required)
     * @param  \criteo\api\retailmedia\v2027_01\Model\BatchStoreInventoryRequest $batch_store_inventory_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['upsertStoreInventoryPerMerchantId'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\v2027_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function upsertStoreInventoryPerMerchantIdRequest($merchant_id, $batch_store_inventory_request, string $contentType = self::contentTypes['upsertStoreInventoryPerMerchantId'][0])
    {
        ...
        $resourcePath = '/2027-01/retail-media/catalog/merchants/{merchantId}/store-inventory/upsert';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
