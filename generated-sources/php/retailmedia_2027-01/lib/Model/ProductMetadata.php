...
class ProductMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductMetadata';
    ...
    */
     ...
     * Sets limit
     *
     * @param int|null $limit Maximum number of items in the response.
     *
     * @return self
     */
     ...
     * Sets response_count
     *
     * @param int|null $response_count Number of items in the response.
     *
     * @return self
     */
