...
/**
 * MonthlyLineItemBudegetOverride Class Doc Comment
 *
 * @category Class
 ...
 */
class MonthlyLineItemBudegetOverride implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MonthlyLineItemBudegetOverride';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['max_monthly_spend'] === null) {
            $invalidProperties[] = "'max_monthly_spend' can't be null";
        }
     ...
     * Sets duration
     *
     * @param string $duration The number of MONTHs that the override is active from StartMonth, e.g. \"1M\". Must end with 'M' or 'm'.
     *
     * @return self
     */
    ...
    /**
     * Gets max_monthly_spend
     *
     * @return float
     */
    public function getMaxMonthlySpend()
    {
        return $this->container['max_monthly_spend'];
    }

    /**
     * Sets max_monthly_spend
     *
     * @param float $max_monthly_spend Monthly budget override maximum monthly spend amount.
     *
     * @return self
     */
    public function setMaxMonthlySpend($max_monthly_spend)
    {
        if (is_null($max_monthly_spend)) {
     ...
     * Sets status
     *
     * @param string|null $status Monthly budget override computed status.
     *
     * @return self
     */
