...
/**
 * SponsoredProductsLineItemUpdateRequestModel Class Doc Comment
 *
 * @category Class
 ...
 */
class SponsoredProductsLineItemUpdateRequestModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SponsoredProductsLineItemUpdateRequestModel';
    ...
    protected static $openAPITypes = [
        ...
        'daily_pacing' => 'float',
        'end_date' => '\DateTime',
        'flight_schedule' => '\criteo\api\retailmedia\v2027_01\Model\FlightSchedule',
    ...
    */
     ...
     * Sets bid_strategy
     *
     * @param string|null $bid_strategy The bid strategy for the line item.
     *
     * @return self
     */
     ...
     *
     * @return \criteo\api\retailmedia\v2027_01\Model\FlightSchedule|null
     */
     ...
     *
     * @param \criteo\api\retailmedia\v2027_01\Model\FlightSchedule|null $flight_schedule flight_schedule
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling SponsoredProductsLineItemUpdateRequestModel., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling SponsoredProductsLineItemUpdateRequestModel., must be bigger than or equal to 0.');
        }
