...
/**
 * AddFundsToBalanceV3 Class Doc Comment
 *
 * @category Class
 ...
 */
class AddFundsToBalanceV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddFundsToBalanceV3';
    ...
    */
    ...
    public function setRetailerPoNumber($retailer_po_number)
    {
        if (is_null($retailer_po_number)) {
            throw new \InvalidArgumentException('non-nullable retailer_po_number cannot be null');
        }
