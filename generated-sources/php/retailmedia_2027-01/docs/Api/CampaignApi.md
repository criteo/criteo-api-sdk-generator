# criteo\api\retailmedia\v2027_01\CampaignApi
...
```php
addRemoveKeywords($id, $add_remove_keywords_model_request): \criteo\api\retailmedia\v2027_01\Model\ResourceOutcome
```
...
$apiInstance = new criteo\api\retailmedia\v2027_01\Api\CampaignApi(
...
$add_remove_keywords_model_request = new \criteo\api\retailmedia\v2027_01\Model\AddRemoveKeywordsModelRequest(); // \criteo\api\retailmedia\v2027_01\Model\AddRemoveKeywordsModelRequest
...
| **add_remove_keywords_model_request** | [**\criteo\api\retailmedia\v2027_01\Model\AddRemoveKeywordsModelRequest**](../Model/AddRemoveKeywordsModelRequest.md)|  | [optional] |

### Return type

[**\criteo\api\retailmedia\v2027_01\Model\ResourceOutcome**](../Model/ResourceOutcome.md)
...
```php
appendAddToBasketTargetsByLineItemId($line_item_id, $add_to_basket_ids_update_model202110_request): \criteo\api\retailmedia\v2027_01\Model\AddToBasketTarget202110Response
```
...
$add_to_basket_ids_update_model202110_request = new \criteo\api\retailmedia\v2027_01\Model\AddToBasketIdsUpdateModel202110Request(); // \criteo\api\retailmedia\v2027_01\Model\AddToBasketIdsUpdateModel202110Request | Ids to append to the target
...
| **add_to_basket_ids_update_model202110_request** | [**\criteo\api\retailmedia\v2027_01\Model\AddToBasketIdsUpdateModel202110Request**](../Model/AddToBasketIdsUpdateModel202110Request.md)| Ids to append to the target | [optional] |

### Return type

[**\criteo\api\retailmedia\v2027_01\Model\AddToBasketTarget202110Response**](../Model/AddToBasketTarget202110Response.md)
...
```php
appendAudienceTargetsByLineItemId($line_item_id, $audience_ids_update_model202110_request): \criteo\api\retailmedia\v2027_01\Model\AudienceTarget202110Response
```
...
$line_item_id = 'line_item_id_example'; // string | The line item to interact with
$audience_ids_update_model202110_request = new \criteo\api\retailmedia\v2027_01\Model\AudienceIdsUpdateModel202110Request(); // \criteo\api\retailmedia\v2027_01\Model\AudienceIdsUpdateModel202110Request | Audience ids to append to the target
...
| ------------- | ------------- | ------------- | ------------- |
| **line_item_id** | **string**| The line item to interact with | |
| **audience_ids_update_model202110_request** | [**\criteo\api\retailmedia\v2027_01\Model\AudienceIdsUpdateModel202110Request**](../Model/AudienceIdsUpdateModel202110Request.md)| Audience ids to append to the target | [optional] |

### Return type

[**\criteo\api\retailmedia\v2027_01\Model\AudienceTarget202110Response**](../Model/AudienceTarget202110Response.md)
...
```php
appendCampaignsToBalanceV1($balance_id, $value_resource_input_append_campaigns_request_v1): \criteo\api\retailmedia\v2027_01\Model\ValueResourceOutcomeBalanceCampaignsV1
```
...
$value_resource_input_append_campaigns_request_v1 = new \criteo\api\retailmedia\v2027_01\Model\ValueResourceInputAppendCampaignsRequestV1(); // \criteo\api\retailmedia\v2027_01\Model\ValueResourceInputAppendCampaignsRequestV1 | The balance campaign appending request.
...
| **value_resource_input_append_campaigns_request_v1** | [**\criteo\api\retailmedia\v2027_01\Model\ValueResourceInputAppendCampaignsRequestV1**](../Model/ValueResourceInputAppendCampaignsRequestV1.md)| The balance campaign appending request. | |

### Return type

[**\criteo\api\retailmedia\v2027_01\Model\ValueResourceOutcomeBalanceCampaignsV1**](../Model/ValueResourceOutcomeBalanceCampaignsV1.md)
...
```php
appendPromotedProducts($line_item_id, $promoted_product_resource_collection_input): \criteo\api\retailmedia\v2027_01\Model\ProductResourceOutcome
```
...
$promoted_product_resource_collection_input = new \criteo\api\retailmedia\v2027_01\Model\PromotedProductResourceCollectionInput(); // \criteo\api\retailmedia\v2027_01\Model\PromotedProductResourceCollectionInput | Request body whose {data} contains an array of promoted products.
...
| **promoted_product_resource_collection_input** | [**\criteo\api\retailmedia\v2027_01\Model\PromotedProductResourceCollectionInput**](../Model/PromotedProductResourceCollectionInput.md)| Request body whose {data} contains an array of promoted products. | [optional] |

### Return type

[**\criteo\api\retailmedia\v2027_01\Model\ProductResourceOutcome**](../Model/ProductResourceOutcome.md)
...
```php
appendStoreTargetsByLineItemId($line_item_id, $store_ids_update_model202110_request): \criteo\api\retailmedia\v2027_01\Model\StoreTarget202110Response
```
...
$line_item_id = 'line_item_id_example'; // string | The line item to interact with
$store_ids_update_model202110_request = new \criteo\api\retailmedia\v2027_01\Model\StoreIdsUpdateModel202110Request(); // \criteo\api\retailmedia\v2027_01\Model\StoreIdsUpdateModel202110Request | Store ids to append to the target
...
| ------------- | ------------- | ------------- | ------------- |
| **line_item_id** | **string**| The line item to interact with | |
| **store_ids_update_model202110_request** | [**\criteo\api\retailmedia\v2027_01\Model\StoreIdsUpdateModel202110Request**](../Model/StoreIdsUpdateModel202110Request.md)| Store ids to append to the target | [optional] |

### Return type

[**\criteo\api\retailmedia\v2027_01\Model\StoreTarget202110Response**](../Model/StoreTarget202110Response.md)
...
```php
createAsset($asset_file): \criteo\api\retailmedia\v2027_01\Model\AssetResponse
```
...
[**\criteo\api\retailmedia\v2027_01\Model\AssetResponse**](../Model/AssetResponse.md)
...
```php
createAuctionLineItem($campaign_id, $value_resource_input_of_sponsored_products_line_item_create_request_model): \criteo\api\retailmedia\v2027_01\Model\EntityResourceOutcomeOfSponsoredProductsLineItem
```
...
$value_resource_input_of_sponsored_products_line_item_create_request_model = new \criteo\api\retailmedia\v2027_01\Model\ValueResourceInputOfSponsoredProductsLineItemCreateRequestModel(); // \criteo\api\retailmedia\v2027_01\Model\ValueResourceInputOfSponsoredProductsLineItemCreateRequestModel | The line item settings to create a line item with
...
| **value_resource_input_of_sponsored_products_line_item_create_request_model** | [**\criteo\api\retailmedia\v2027_01\Model\ValueResourceInputOfSponsoredProductsLineItemCreateRequestModel**](../Model/ValueResourceInputOfSponsoredProductsLineItemCreateRequestModel.md)| The line item settings to create a line item with | |

### Return type

[**\criteo\api\retailmedia\v2027_01\Model\EntityResourceOutcomeOfSponsoredProductsLineItem**](../Model/EntityResourceOutcomeOfSponsoredProductsLineItem.md)
...
```php
createBrandCatalogExport($account_id, $value_resource_input_of_brand_catalog_request_v2): \criteo\api\retailmedia\v2027_01\Model\EntityResourceOutcomeOfCatalogStatusV2
```
...
$value_resource_input_of_brand_catalog_request_v2 = new \criteo\api\retailmedia\v2027_01\Model\ValueResourceInputOfBrandCatalogRequestV2(); // \criteo\api\retailmedia\v2027_01\Model\ValueResourceInputOfBrandCatalogRequestV2
...
| **value_resource_input_of_brand_catalog_request_v2** | [**\criteo\api\retailmedia\v2027_01\Model\ValueResourceInputOfBrandCatalogRequestV2**](../Model/ValueResourceInputOfBrandCatalogRequestV2.md)|  | |

### Return type

[**\criteo\api\retailmedia\v2027_01\Model\EntityResourceOutcomeOfCatalogStatusV2**](../Model/EntityResourceOutcomeOfCatalogStatusV2.md)
...
```php
createCampaignsByAccountId($account_id, $post_campaign_v202301): \criteo\api\retailmedia\v2027_01\Model\JsonApiSingleResponseOfCampaignV202301
```
...
$post_campaign_v202301 = new \criteo\api\retailmedia\v2027_01\Model\PostCampaignV202301(); // \criteo\api\retailmedia\v2027_01\Model\PostCampaignV202301 | The campaign settings to create a campaign with
...
| **post_campaign_v202301** | [**\criteo\api\retailmedia\v2027_01\Model\PostCampaignV202301**](../Model/PostCampaignV202301.md)| The campaign settings to create a campaign with | |

### Return type

[**\criteo\api\retailmedia\v2027_01\Model\JsonApiSingleResponseOfCampaignV202301**](../Model/JsonApiSingleResponseOfCampaignV202301.md)
...
```php
createCreative($account_id, $creative_create_model202207): \criteo\api\retailmedia\v2027_01\Model\Creative202210Response
```
...
$creative_create_model202207 = new \criteo\api\retailmedia\v2027_01\Model\CreativeCreateModel202207(); // \criteo\api\retailmedia\v2027_01\Model\CreativeCreateModel202207 | The creative to create
...
| **creative_create_model202207** | [**\criteo\api\retailmedia\v2027_01\Model\CreativeCreateModel202207**](../Model/CreativeCreateModel202207.md)| The creative to create | |

### Return type

[**\criteo\api\retailmedia\v2027_01\Model\Creative202210Response**](../Model/Creative202210Response.md)
...
```php
createPreferredLineItemByCampaignId($campaign_id, $preferred_line_item_create_model_v2_request): \criteo\api\retailmedia\v2027_01\Model\PreferredLineItemV2Response
```
...
$campaign_id = 'campaign_id_example'; // string | The given campaign id
$preferred_line_item_create_model_v2_request = new \criteo\api\retailmedia\v2027_01\Model\PreferredLineItemCreateModelV2Request(); // \criteo\api\retailmedia\v2027_01\Model\PreferredLineItemCreateModelV2Request | The line item settings to create a line item with
...
| ------------- | ------------- | ------------- | ------------- |
| **campaign_id** | **string**| The given campaign id | |
| **preferred_line_item_create_model_v2_request** | [**\criteo\api\retailmedia\v2027_01\Model\PreferredLineItemCreateModelV2Request**](../Model/PreferredLineItemCreateModelV2Request.md)| The line item settings to create a line item with | |

### Return type

[**\criteo\api\retailmedia\v2027_01\Model\PreferredLineItemV2Response**](../Model/PreferredLineItemV2Response.md)
...
```php
createSellerCatalogExport($account_id, $value_resource_input_of_seller_catalog_request_v2): \criteo\api\retailmedia\v2027_01\Model\EntityResourceOutcomeOfCatalogStatusV2
```
...
$account_id = 'account_id_example'; // string | The account to request the catalog for.
$value_resource_input_of_seller_catalog_request_v2 = new \criteo\api\retailmedia\v2027_01\Model\ValueResourceInputOfSellerCatalogRequestV2(); // \criteo\api\retailmedia\v2027_01\Model\ValueResourceInputOfSellerCatalogRequestV2
...
| ------------- | ------------- | ------------- | ------------- |
| **account_id** | **string**| The account to request the catalog for. | |
| **value_resource_input_of_seller_catalog_request_v2** | [**\criteo\api\retailmedia\v2027_01\Model\ValueResourceInputOfSellerCatalogRequestV2**](../Model/ValueResourceInputOfSellerCatalogRequestV2.md)|  | |
...
```php
deleteAddToBasketTargetsByLineItemId($line_item_id, $add_to_basket_ids_update_model202110_request): \criteo\api\retailmedia\v2027_01\Model\AddToBasketTarget202110Response
```
...
$line_item_id = 'line_item_id_example'; // string | The line item to interact with
$add_to_basket_ids_update_model202110_request = new \criteo\api\retailmedia\v2027_01\Model\AddToBasketIdsUpdateModel202110Request(); // \criteo\api\retailmedia\v2027_01\Model\AddToBasketIdsUpdateModel202110Request | Ids to remove from the target
...
| ------------- | ------------- | ------------- | ------------- |
| **line_item_id** | **string**| The line item to interact with | |
| **add_to_basket_ids_update_model202110_request** | [**\criteo\api\retailmedia\v2027_01\Model\AddToBasketIdsUpdateModel202110Request**](../Model/AddToBasketIdsUpdateModel202110Request.md)| Ids to remove from the target | [optional] |
...
```php
deleteAudienceTargetsByLineItemId($line_item_id, $audience_ids_update_model202110_request): \criteo\api\retailmedia\v2027_01\Model\AudienceTarget202110Response
```
...
$line_item_id = 'line_item_id_example'; // string | The line item to interact with
$audience_ids_update_model202110_request = new \criteo\api\retailmedia\v2027_01\Model\AudienceIdsUpdateModel202110Request(); // \criteo\api\retailmedia\v2027_01\Model\AudienceIdsUpdateModel202110Request | Audience ids to remove from the target
...
| ------------- | ------------- | ------------- | ------------- |
| **line_item_id** | **string**| The line item to interact with | |
| **audience_ids_update_model202110_request** | [**\criteo\api\retailmedia\v2027_01\Model\AudienceIdsUpdateModel202110Request**](../Model/AudienceIdsUpdateModel202110Request.md)| Audience ids to remove from the target | [optional] |
...
```php
deleteCampaignsFromBalanceV1($balance_id, $value_resource_input_delete_campaigns_request_v1): \criteo\api\retailmedia\v2027_01\Model\ValueResourceOutcomeBalanceCampaignsV1
```
...
$value_resource_input_delete_campaigns_request_v1 = new \criteo\api\retailmedia\v2027_01\Model\ValueResourceInputDeleteCampaignsRequestV1(); // \criteo\api\retailmedia\v2027_01\Model\ValueResourceInputDeleteCampaignsRequestV1 | The balance campaign deleting request.
...
| **value_resource_input_delete_campaigns_request_v1** | [**\criteo\api\retailmedia\v2027_01\Model\ValueResourceInputDeleteCampaignsRequestV1**](../Model/ValueResourceInputDeleteCampaignsRequestV1.md)| The balance campaign deleting request. | |
...
```php
deleteStoreTargetByLineItemId($line_item_id, $store_ids_update_model202110_request): \criteo\api\retailmedia\v2027_01\Model\StoreTarget202110Response
```
...
$line_item_id = 'line_item_id_example'; // string | The line item to interact with
$store_ids_update_model202110_request = new \criteo\api\retailmedia\v2027_01\Model\StoreIdsUpdateModel202110Request(); // \criteo\api\retailmedia\v2027_01\Model\StoreIdsUpdateModel202110Request | Store ids to remove from the target
...
| ------------- | ------------- | ------------- | ------------- |
| **line_item_id** | **string**| The line item to interact with | |
| **store_ids_update_model202110_request** | [**\criteo\api\retailmedia\v2027_01\Model\StoreIdsUpdateModel202110Request**](../Model/StoreIdsUpdateModel202110Request.md)| Store ids to remove from the target | [optional] |
...
```php
fetchPromotedProducts($line_item_id, $fields, $limit, $offset): \criteo\api\retailmedia\v2027_01\Model\PromotedProductResourceCollectionOutcome
```
...
[**\criteo\api\retailmedia\v2027_01\Model\PromotedProductResourceCollectionOutcome**](../Model/PromotedProductResourceCollectionOutcome.md)
...
```php
getAccountCreatives($account_id): \criteo\api\retailmedia\v2027_01\Model\Creative202110ListResponse
```
...
[**\criteo\api\retailmedia\v2027_01\Model\Creative202110ListResponse**](../Model/Creative202110ListResponse.md)
...
```php
getAddToBasketTargetsByLineItemId($line_item_id): \criteo\api\retailmedia\v2027_01\Model\AddToBasketTarget202110Response
```
...
```php
getApi202110ExternalRetailerPagesByRetailerId($retailer_id): \criteo\api\retailmedia\v2027_01\Model\RetailerPages202110
```
...
[**\criteo\api\retailmedia\v2027_01\Model\RetailerPages202110**](../Model/RetailerPages202110.md)
...
```php
getApiExternalV1Categories($page_index, $page_size, $retailer_id, $text_substring): \criteo\api\retailmedia\v2027_01\Model\Category202204ListResponse
```
...
[**\criteo\api\retailmedia\v2027_01\Model\Category202204ListResponse**](../Model/Category202204ListResponse.md)
...
```php
getAuctionLineItem($line_item_id): \criteo\api\retailmedia\v2027_01\Model\EntityResourceOutcomeOfSponsoredProductsLineItem
```
...
```php
getAuctionLineItemsByCampaign($campaign_id, $limit, $limit_to_ids, $offset): \criteo\api\retailmedia\v2027_01\Model\EntityResourceCollectionOutcomeOfSponsoredProductsLineItemAndMetadata
```
...
[**\criteo\api\retailmedia\v2027_01\Model\EntityResourceCollectionOutcomeOfSponsoredProductsLineItemAndMetadata**](../Model/EntityResourceCollectionOutcomeOfSponsoredProductsLineItemAndMetadata.md)
...
```php
getAudienceTargetsByLineItemId($line_item_id): \criteo\api\retailmedia\v2027_01\Model\AudienceTarget202110Response
```
...
```php
getBidMultipliersByLineItemId($line_item_id): \criteo\api\retailmedia\v2027_01\Model\JsonApiSingleResponseOfLineItemBidMultipliersV2
```
...
[**\criteo\api\retailmedia\v2027_01\Model\JsonApiSingleResponseOfLineItemBidMultipliersV2**](../Model/JsonApiSingleResponseOfLineItemBidMultipliersV2.md)
...
```php
getBrandsByAccountId($account_id, $limit_to_id, $page_index, $page_size): \criteo\api\retailmedia\v2027_01\Model\JsonApiPageResponseOfBrand
```
...
[**\criteo\api\retailmedia\v2027_01\Model\JsonApiPageResponseOfBrand**](../Model/JsonApiPageResponseOfBrand.md)
...
```php
getCampaignBudgetOverrides($campaign_id): \criteo\api\retailmedia\v2027_01\Model\ValueResourceOutcomeOfCampaignBudgetOverrides
```
...
[**\criteo\api\retailmedia\v2027_01\Model\ValueResourceOutcomeOfCampaignBudgetOverrides**](../Model/ValueResourceOutcomeOfCampaignBudgetOverrides.md)
...
```php
getCampaignByCampaignId($campaign_id): \criteo\api\retailmedia\v2027_01\Model\JsonApiSingleResponseOfCampaignV202301
```
...
```php
getCampaignsByAccountId($account_id, $limit_to_id, $page_index, $page_size): \criteo\api\retailmedia\v2027_01\Model\JsonApiPageResponseOfCampaignV202301
```
...
[**\criteo\api\retailmedia\v2027_01\Model\JsonApiPageResponseOfCampaignV202301**](../Model/JsonApiPageResponseOfCampaignV202301.md)
...
```php
getCatalogStatus($catalog_id): \criteo\api\retailmedia\v2027_01\Model\JsonApiSingleResponseOfCatalogStatus
```
...
[**\criteo\api\retailmedia\v2027_01\Model\JsonApiSingleResponseOfCatalogStatus**](../Model/JsonApiSingleResponseOfCatalogStatus.md)
...
```php
getCategory($category_id): \criteo\api\retailmedia\v2027_01\Model\Category202204
```
...
[**\criteo\api\retailmedia\v2027_01\Model\Category202204**](../Model/Category202204.md)
...
```php
getCpcMinBidsBySkuIdsV1($retailer_id, $value_resource_input_cpc_min_bids_request): \criteo\api\retailmedia\v2027_01\Model\ValueResourceOutcomeCpcMinBidsResponse
```
...
$value_resource_input_cpc_min_bids_request = new \criteo\api\retailmedia\v2027_01\Model\ValueResourceInputCpcMinBidsRequest(); // \criteo\api\retailmedia\v2027_01\Model\ValueResourceInputCpcMinBidsRequest | Cpc minimum bid amount request object.
...
| **value_resource_input_cpc_min_bids_request** | [**\criteo\api\retailmedia\v2027_01\Model\ValueResourceInputCpcMinBidsRequest**](../Model/ValueResourceInputCpcMinBidsRequest.md)| Cpc minimum bid amount request object. | |

### Return type

[**\criteo\api\retailmedia\v2027_01\Model\ValueResourceOutcomeCpcMinBidsResponse**](../Model/ValueResourceOutcomeCpcMinBidsResponse.md)
...
```php
getCreative($account_id, $creative_id): \criteo\api\retailmedia\v2027_01\Model\Creative2Response
```
...
[**\criteo\api\retailmedia\v2027_01\Model\Creative2Response**](../Model/Creative2Response.md)
...
```php
getCreativeTemplate($retailer_id, $template_id): \criteo\api\retailmedia\v2027_01\Model\TemplateResponse
```
...
[**\criteo\api\retailmedia\v2027_01\Model\TemplateResponse**](../Model/TemplateResponse.md)
...
```php
getKeywordInReviewReport($account_id, $limit, $offset): \criteo\api\retailmedia\v2027_01\Model\EntityResourceCollectionOutcomeLineItemKeywordReviewReportAndMetadata
```
...
[**\criteo\api\retailmedia\v2027_01\Model\EntityResourceCollectionOutcomeLineItemKeywordReviewReportAndMetadata**](../Model/EntityResourceCollectionOutcomeLineItemKeywordReviewReportAndMetadata.md)
...
```php
getLineItemBudgetOverrides($line_item_id): \criteo\api\retailmedia\v2027_01\Model\ValueResourceOutcomeOfLineItemBudgetOverrides
```
...
[**\criteo\api\retailmedia\v2027_01\Model\ValueResourceOutcomeOfLineItemBudgetOverrides**](../Model/ValueResourceOutcomeOfLineItemBudgetOverrides.md)
...
```php
getLineItemsByAccountId($account_id, $limit_to_campaign_id, $limit_to_id, $limit_to_type, $page_index, $page_size): \criteo\api\retailmedia\v2027_01\Model\CommonLineItemPagedListResponse
```
...
[**\criteo\api\retailmedia\v2027_01\Model\CommonLineItemPagedListResponse**](../Model/CommonLineItemPagedListResponse.md)
...
```php
getLineItemsByCampaignId($line_item_id): \criteo\api\retailmedia\v2027_01\Model\CommonLineItemResponse
```
...
[**\criteo\api\retailmedia\v2027_01\Model\CommonLineItemResponse**](../Model/CommonLineItemResponse.md)
...
```php
getPreferredLineItemsByCampaignId($campaign_id, $limit_to_id, $page_index, $page_size): \criteo\api\retailmedia\v2027_01\Model\PreferredLineItemV2PagedListResponse
```
...
[**\criteo\api\retailmedia\v2027_01\Model\PreferredLineItemV2PagedListResponse**](../Model/PreferredLineItemV2PagedListResponse.md)
...
```php
getPreferredLineItemsByLineItemId($line_item_id): \criteo\api\retailmedia\v2027_01\Model\PreferredLineItemV2Response
```
...
```php
getRecommendedCategories($retailer_id, $value_resource_input_recommended_categories_request_v1): \criteo\api\retailmedia\v2027_01\Model\EntityResourceCollectionOutcomeCategory202204
```
...
$retailer_id = 'retailer_id_example'; // string | Retailer id.
$value_resource_input_recommended_categories_request_v1 = new \criteo\api\retailmedia\v2027_01\Model\ValueResourceInputRecommendedCategoriesRequestV1(); // \criteo\api\retailmedia\v2027_01\Model\ValueResourceInputRecommendedCategoriesRequestV1 | Request of recommended categories.
...
| ------------- | ------------- | ------------- | ------------- |
| **retailer_id** | **string**| Retailer id. | |
| **value_resource_input_recommended_categories_request_v1** | [**\criteo\api\retailmedia\v2027_01\Model\ValueResourceInputRecommendedCategoriesRequestV1**](../Model/ValueResourceInputRecommendedCategoriesRequestV1.md)| Request of recommended categories. | |

### Return type

[**\criteo\api\retailmedia\v2027_01\Model\EntityResourceCollectionOutcomeCategory202204**](../Model/EntityResourceCollectionOutcomeCategory202204.md)
...
```php
getRecommendedKeywords($external_line_item_id): \criteo\api\retailmedia\v2027_01\Model\ValueResourceOutcomeOfRecommendedKeywordsResult
```
...
[**\criteo\api\retailmedia\v2027_01\Model\ValueResourceOutcomeOfRecommendedKeywordsResult**](../Model/ValueResourceOutcomeOfRecommendedKeywordsResult.md)
...
```php
getRetailerCreativeTemplates($retailer_id): \criteo\api\retailmedia\v2027_01\Model\TemplateListResponse
```
...
[**\criteo\api\retailmedia\v2027_01\Model\TemplateListResponse**](../Model/TemplateListResponse.md)
...
```php
getStoreTargetsByLineItemId($line_item_id): \criteo\api\retailmedia\v2027_01\Model\StoreTarget202110Response
```
...
```php
postApiExternalV1AccountCatalogsSellersByAccountId($account_id, $json_api_request_of_seller_catalog_request): \criteo\api\retailmedia\v2027_01\Model\JsonApiSingleResponseOfCatalogStatus
```
...
$account_id = 'account_id_example'; // string | The account to request the catalog for.
$json_api_request_of_seller_catalog_request = new \criteo\api\retailmedia\v2027_01\Model\JsonApiRequestOfSellerCatalogRequest(); // \criteo\api\retailmedia\v2027_01\Model\JsonApiRequestOfSellerCatalogRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **account_id** | **string**| The account to request the catalog for. | |
| **json_api_request_of_seller_catalog_request** | [**\criteo\api\retailmedia\v2027_01\Model\JsonApiRequestOfSellerCatalogRequest**](../Model/JsonApiRequestOfSellerCatalogRequest.md)|  | |
...
```php
postApiV1ExternalAccountCatalogsByAccountId($account_id, $json_api_request_of_catalog_request): \criteo\api\retailmedia\v2027_01\Model\JsonApiSingleResponseOfCatalogStatus
```
...
$account_id = 'account_id_example'; // string | The account to request the catalog for.
$json_api_request_of_catalog_request = new \criteo\api\retailmedia\v2027_01\Model\JsonApiRequestOfCatalogRequest(); // \criteo\api\retailmedia\v2027_01\Model\JsonApiRequestOfCatalogRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **account_id** | **string**| The account to request the catalog for. | |
| **json_api_request_of_catalog_request** | [**\criteo\api\retailmedia\v2027_01\Model\JsonApiRequestOfCatalogRequest**](../Model/JsonApiRequestOfCatalogRequest.md)|  | |
...
```php
putAddToBasketTargetByLineItemId($line_item_id, $add_to_basket_target202110_request): \criteo\api\retailmedia\v2027_01\Model\AddToBasketTarget202110Response
```
...
$line_item_id = 'line_item_id_example'; // string | The line item to interact with
$add_to_basket_target202110_request = new \criteo\api\retailmedia\v2027_01\Model\AddToBasketTarget202110Request(); // \criteo\api\retailmedia\v2027_01\Model\AddToBasketTarget202110Request | The add to basket target to set the scope for
...
| ------------- | ------------- | ------------- | ------------- |
| **line_item_id** | **string**| The line item to interact with | |
| **add_to_basket_target202110_request** | [**\criteo\api\retailmedia\v2027_01\Model\AddToBasketTarget202110Request**](../Model/AddToBasketTarget202110Request.md)| The add to basket target to set the scope for | |
...
```php
putAudienceTargetsByLineItemId($line_item_id, $audience_target202110_request): \criteo\api\retailmedia\v2027_01\Model\AudienceTarget202110Response
```
...
$line_item_id = 'line_item_id_example'; // string | The line item to interact with
$audience_target202110_request = new \criteo\api\retailmedia\v2027_01\Model\AudienceTarget202110Request(); // \criteo\api\retailmedia\v2027_01\Model\AudienceTarget202110Request | The audience target to set the scope for
...
| ------------- | ------------- | ------------- | ------------- |
| **line_item_id** | **string**| The line item to interact with | |
| **audience_target202110_request** | [**\criteo\api\retailmedia\v2027_01\Model\AudienceTarget202110Request**](../Model/AudienceTarget202110Request.md)| The audience target to set the scope for | |
...
```php
putStoreTargetByLineItemId($line_item_id, $store_target202110_request): \criteo\api\retailmedia\v2027_01\Model\StoreTarget202110Response
```
...
$line_item_id = 'line_item_id_example'; // string | The line item to interact with
$store_target202110_request = new \criteo\api\retailmedia\v2027_01\Model\StoreTarget202110Request(); // \criteo\api\retailmedia\v2027_01\Model\StoreTarget202110Request | The store target to set the scope for
...
| ------------- | ------------- | ------------- | ------------- |
| **line_item_id** | **string**| The line item to interact with | |
| **store_target202110_request** | [**\criteo\api\retailmedia\v2027_01\Model\StoreTarget202110Request**](../Model/StoreTarget202110Request.md)| The store target to set the scope for | |
...
```php
recommendedKeywords($retailer_id, $value_resource_input_recommended_keywords_request_v1): \criteo\api\retailmedia\v2027_01\Model\ValueResourceOutcomeRecommendedKeywordsResponseV1
```
...
$retailer_id = 'retailer_id_example'; // string | Retailer id.
$value_resource_input_recommended_keywords_request_v1 = new \criteo\api\retailmedia\v2027_01\Model\ValueResourceInputRecommendedKeywordsRequestV1(); // \criteo\api\retailmedia\v2027_01\Model\ValueResourceInputRecommendedKeywordsRequestV1 | Request of recommended keywords.
...
| ------------- | ------------- | ------------- | ------------- |
| **retailer_id** | **string**| Retailer id. | |
| **value_resource_input_recommended_keywords_request_v1** | [**\criteo\api\retailmedia\v2027_01\Model\ValueResourceInputRecommendedKeywordsRequestV1**](../Model/ValueResourceInputRecommendedKeywordsRequestV1.md)| Request of recommended keywords. | |

### Return type

[**\criteo\api\retailmedia\v2027_01\Model\ValueResourceOutcomeRecommendedKeywordsResponseV1**](../Model/ValueResourceOutcomeRecommendedKeywordsResponseV1.md)
...
```php
searchAccountCreatives($account_id, $creative_ids): \criteo\api\retailmedia\v2027_01\Model\Creative2ListResponse
```
...
[**\criteo\api\retailmedia\v2027_01\Model\Creative2ListResponse**](../Model/Creative2ListResponse.md)
...
```php
searchAccountRetailers($account_id, $value_resource_input_of_retailer_search_request_v2, $limit, $offset): \criteo\api\retailmedia\v2027_01\Model\EntityResourceCollectionOutcomeOfRetailerResultV2AndMetadata
```
...
$value_resource_input_of_retailer_search_request_v2 = new \criteo\api\retailmedia\v2027_01\Model\ValueResourceInputOfRetailerSearchRequestV2(); // \criteo\api\retailmedia\v2027_01\Model\ValueResourceInputOfRetailerSearchRequestV2 | The search request containing filtering parameters
...
| **value_resource_input_of_retailer_search_request_v2** | [**\criteo\api\retailmedia\v2027_01\Model\ValueResourceInputOfRetailerSearchRequestV2**](../Model/ValueResourceInputOfRetailerSearchRequestV2.md)| The search request containing filtering parameters | |
...
[**\criteo\api\retailmedia\v2027_01\Model\EntityResourceCollectionOutcomeOfRetailerResultV2AndMetadata**](../Model/EntityResourceCollectionOutcomeOfRetailerResultV2AndMetadata.md)
...
```php
searchCategory($retailer_id, $limit, $offset, $value_resource_input_categories_search_request_v1): \criteo\api\retailmedia\v2027_01\Model\EntityResourceCollectionOutcomeCategory202204Metadata
```
...
$value_resource_input_categories_search_request_v1 = new \criteo\api\retailmedia\v2027_01\Model\ValueResourceInputCategoriesSearchRequestV1(); // \criteo\api\retailmedia\v2027_01\Model\ValueResourceInputCategoriesSearchRequestV1 | Request of categories search.
...
| **value_resource_input_categories_search_request_v1** | [**\criteo\api\retailmedia\v2027_01\Model\ValueResourceInputCategoriesSearchRequestV1**](../Model/ValueResourceInputCategoriesSearchRequestV1.md)| Request of categories search. | [optional] |

### Return type

[**\criteo\api\retailmedia\v2027_01\Model\EntityResourceCollectionOutcomeCategory202204Metadata**](../Model/EntityResourceCollectionOutcomeCategory202204Metadata.md)
...
```php
setKeywordBids($id, $set_bids_model_request): \criteo\api\retailmedia\v2027_01\Model\ResourceOutcome
```
...
$id = 'id_example'; // string | ID of the line item
$set_bids_model_request = new \criteo\api\retailmedia\v2027_01\Model\SetBidsModelRequest(); // \criteo\api\retailmedia\v2027_01\Model\SetBidsModelRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **id** | **string**| ID of the line item | |
| **set_bids_model_request** | [**\criteo\api\retailmedia\v2027_01\Model\SetBidsModelRequest**](../Model/SetBidsModelRequest.md)|  | [optional] |
...
```php
updateAuctionLineItem($line_item_id, $value_resource_input_of_sponsored_products_line_item_update_request_model): \criteo\api\retailmedia\v2027_01\Model\EntityResourceOutcomeOfSponsoredProductsLineItem
```
...
$value_resource_input_of_sponsored_products_line_item_update_request_model = new \criteo\api\retailmedia\v2027_01\Model\ValueResourceInputOfSponsoredProductsLineItemUpdateRequestModel(); // \criteo\api\retailmedia\v2027_01\Model\ValueResourceInputOfSponsoredProductsLineItemUpdateRequestModel | An update request containing all details of the requested update.
...
| **value_resource_input_of_sponsored_products_line_item_update_request_model** | [**\criteo\api\retailmedia\v2027_01\Model\ValueResourceInputOfSponsoredProductsLineItemUpdateRequestModel**](../Model/ValueResourceInputOfSponsoredProductsLineItemUpdateRequestModel.md)| An update request containing all details of the requested update. | |
...
```php
updateBidMultipliersByLineItemId($line_item_id, $line_item_bid_multipliers_v2_request): \criteo\api\retailmedia\v2027_01\Model\LineItemBidMultipliersV2Response
```
...
$line_item_id = 'line_item_id_example'; // string | LineItemId for bid multiplier retrieval
$line_item_bid_multipliers_v2_request = new \criteo\api\retailmedia\v2027_01\Model\LineItemBidMultipliersV2Request(); // \criteo\api\retailmedia\v2027_01\Model\LineItemBidMultipliersV2Request | New Bid Multipliers to be set
...
| ------------- | ------------- | ------------- | ------------- |
| **line_item_id** | **string**| LineItemId for bid multiplier retrieval | |
| **line_item_bid_multipliers_v2_request** | [**\criteo\api\retailmedia\v2027_01\Model\LineItemBidMultipliersV2Request**](../Model/LineItemBidMultipliersV2Request.md)| New Bid Multipliers to be set | |

### Return type

[**\criteo\api\retailmedia\v2027_01\Model\LineItemBidMultipliersV2Response**](../Model/LineItemBidMultipliersV2Response.md)
...
```php
updateCampaignBudgetOverrides($campaign_id, $value_resource_input_of_campaign_budget_overrides): \criteo\api\retailmedia\v2027_01\Model\ValueResourceOutcomeOfCampaignBudgetOverrides
```
...
$campaign_id = 'campaign_id_example'; // string | Campaign id.
$value_resource_input_of_campaign_budget_overrides = new \criteo\api\retailmedia\v2027_01\Model\ValueResourceInputOfCampaignBudgetOverrides(); // \criteo\api\retailmedia\v2027_01\Model\ValueResourceInputOfCampaignBudgetOverrides | New campaign budget overrides settings value resource input.
...
| ------------- | ------------- | ------------- | ------------- |
| **campaign_id** | **string**| Campaign id. | |
| **value_resource_input_of_campaign_budget_overrides** | [**\criteo\api\retailmedia\v2027_01\Model\ValueResourceInputOfCampaignBudgetOverrides**](../Model/ValueResourceInputOfCampaignBudgetOverrides.md)| New campaign budget overrides settings value resource input. | |
...
```php
updateCampaignByCampaignId($campaign_id, $put_campaign_v202301): \criteo\api\retailmedia\v2027_01\Model\JsonApiSingleResponseOfCampaignV202301
```
...
$campaign_id = 'campaign_id_example'; // string | The given campaign id
$put_campaign_v202301 = new \criteo\api\retailmedia\v2027_01\Model\PutCampaignV202301(); // \criteo\api\retailmedia\v2027_01\Model\PutCampaignV202301 | The campaign settings to update that campaign with
...
| ------------- | ------------- | ------------- | ------------- |
| **campaign_id** | **string**| The given campaign id | |
| **put_campaign_v202301** | [**\criteo\api\retailmedia\v2027_01\Model\PutCampaignV202301**](../Model/PutCampaignV202301.md)| The campaign settings to update that campaign with | |
...
```php
updateCreative($account_id, $creative_id, $creative_update_model202207): \criteo\api\retailmedia\v2027_01\Model\Creative202210Response
```
...
$creative_update_model202207 = new \criteo\api\retailmedia\v2027_01\Model\CreativeUpdateModel202207(); // \criteo\api\retailmedia\v2027_01\Model\CreativeUpdateModel202207 | The creative to create
...
| **creative_update_model202207** | [**\criteo\api\retailmedia\v2027_01\Model\CreativeUpdateModel202207**](../Model/CreativeUpdateModel202207.md)| The creative to create | |
...
```php
updateKeywordReviews($line_item_id, $value_resource_input_retail_media_keywords_review): \criteo\api\retailmedia\v2027_01\Model\ValueResourceOutcomeRetailMediaKeywordsReviewResult
```
...
$value_resource_input_retail_media_keywords_review = new \criteo\api\retailmedia\v2027_01\Model\ValueResourceInputRetailMediaKeywordsReview(); // \criteo\api\retailmedia\v2027_01\Model\ValueResourceInputRetailMediaKeywordsReview | Request object containing a list of Phrase-ReviewState pairs to update
...
| **value_resource_input_retail_media_keywords_review** | [**\criteo\api\retailmedia\v2027_01\Model\ValueResourceInputRetailMediaKeywordsReview**](../Model/ValueResourceInputRetailMediaKeywordsReview.md)| Request object containing a list of Phrase-ReviewState pairs to update | [optional] |

### Return type

[**\criteo\api\retailmedia\v2027_01\Model\ValueResourceOutcomeRetailMediaKeywordsReviewResult**](../Model/ValueResourceOutcomeRetailMediaKeywordsReviewResult.md)
...
```php
updateLineItemBudgetOverrides($line_item_id, $value_resource_input_of_line_item_budget_overrides): \criteo\api\retailmedia\v2027_01\Model\ValueResourceOutcomeOfLineItemBudgetOverrides
```
...
$value_resource_input_of_line_item_budget_overrides = new \criteo\api\retailmedia\v2027_01\Model\ValueResourceInputOfLineItemBudgetOverrides(); // \criteo\api\retailmedia\v2027_01\Model\ValueResourceInputOfLineItemBudgetOverrides | New line item budget overrides settings value resource input.
...
| **value_resource_input_of_line_item_budget_overrides** | [**\criteo\api\retailmedia\v2027_01\Model\ValueResourceInputOfLineItemBudgetOverrides**](../Model/ValueResourceInputOfLineItemBudgetOverrides.md)| New line item budget overrides settings value resource input. | |
...
```php
updatePreferredLineItemByLineItemId($line_item_id, $preferred_line_item_update_model_v2_request): \criteo\api\retailmedia\v2027_01\Model\PreferredLineItemV2Response
```
...
$line_item_id = 'line_item_id_example'; // string | The given line item id
$preferred_line_item_update_model_v2_request = new \criteo\api\retailmedia\v2027_01\Model\PreferredLineItemUpdateModelV2Request(); // \criteo\api\retailmedia\v2027_01\Model\PreferredLineItemUpdateModelV2Request | The line item settings to create a line item with
...
| ------------- | ------------- | ------------- | ------------- |
| **line_item_id** | **string**| The given line item id | |
| **preferred_line_item_update_model_v2_request** | [**\criteo\api\retailmedia\v2027_01\Model\PreferredLineItemUpdateModelV2Request**](../Model/PreferredLineItemUpdateModelV2Request.md)| The line item settings to create a line item with | |
