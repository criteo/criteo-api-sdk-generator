# criteo\api\retailmedia\v2027_01\BalanceApi
...
```php
addFundsByAccountAndBalanceId($account_id, $balance_id, $add_funds_to_balance_v3_request): \criteo\api\retailmedia\v2027_01\Model\BalanceResponseV3Response
```
...
$apiInstance = new criteo\api\retailmedia\v2027_01\Api\BalanceApi(
...
$add_funds_to_balance_v3_request = new \criteo\api\retailmedia\v2027_01\Model\AddFundsToBalanceV3Request(); // \criteo\api\retailmedia\v2027_01\Model\AddFundsToBalanceV3Request | An object that represents the available options of adding funds to a balance.
...
| **add_funds_to_balance_v3_request** | [**\criteo\api\retailmedia\v2027_01\Model\AddFundsToBalanceV3Request**](../Model/AddFundsToBalanceV3Request.md)| An object that represents the available options of adding funds to a balance. | |

### Return type

[**\criteo\api\retailmedia\v2027_01\Model\BalanceResponseV3Response**](../Model/BalanceResponseV3Response.md)
...
```php
changeDatesByAccountAndBalanceId($account_id, $balance_id, $change_dates_of_balance_v2_request): \criteo\api\retailmedia\v2027_01\Model\BalanceResponseV2Response
```
...
$change_dates_of_balance_v2_request = new \criteo\api\retailmedia\v2027_01\Model\ChangeDatesOfBalanceV2Request(); // \criteo\api\retailmedia\v2027_01\Model\ChangeDatesOfBalanceV2Request | An object that represents the available options to modify schedule of a balance.
...
| **change_dates_of_balance_v2_request** | [**\criteo\api\retailmedia\v2027_01\Model\ChangeDatesOfBalanceV2Request**](../Model/ChangeDatesOfBalanceV2Request.md)| An object that represents the available options to modify schedule of a balance. | |

### Return type

[**\criteo\api\retailmedia\v2027_01\Model\BalanceResponseV2Response**](../Model/BalanceResponseV2Response.md)
...
```php
createBalanceByAccountId($account_id, $create_balance_v3_request): \criteo\api\retailmedia\v2027_01\Model\BalanceResponseV3Response
```
...
$create_balance_v3_request = new \criteo\api\retailmedia\v2027_01\Model\CreateBalanceV3Request(); // \criteo\api\retailmedia\v2027_01\Model\CreateBalanceV3Request | An object that represents the available options to set when creating a Retail Media Balance
...
| **create_balance_v3_request** | [**\criteo\api\retailmedia\v2027_01\Model\CreateBalanceV3Request**](../Model/CreateBalanceV3Request.md)| An object that represents the available options to set when creating a Retail Media Balance | |
...
```php
getBalanceByAccountAndBalanceId($account_id, $balance_id): \criteo\api\retailmedia\v2027_01\Model\BalanceResponseV2Response
```
...
```php
getBalanceHistoryV1($balance_id, $limit, $limit_to_change_types, $offset): \criteo\api\retailmedia\v2027_01\Model\ValueResourceCollectionOutcomeBalanceHistoryChangeDataCaptureV1AndMetadata
```
...
[**\criteo\api\retailmedia\v2027_01\Model\ValueResourceCollectionOutcomeBalanceHistoryChangeDataCaptureV1AndMetadata**](../Model/ValueResourceCollectionOutcomeBalanceHistoryChangeDataCaptureV1AndMetadata.md)
...
```php
getBalanceV1($balance_id): \criteo\api\retailmedia\v2027_01\Model\EntityResourceOutcomeBalanceV1
```
...
[**\criteo\api\retailmedia\v2027_01\Model\EntityResourceOutcomeBalanceV1**](../Model/EntityResourceOutcomeBalanceV1.md)
...
```php
getCampaignsByBalanceId($balance_id, $limit_to_id, $page_index, $page_size): \criteo\api\retailmedia\v2027_01\Model\BalanceCampaign202110PagedListResponse
```
...
[**\criteo\api\retailmedia\v2027_01\Model\BalanceCampaign202110PagedListResponse**](../Model/BalanceCampaign202110PagedListResponse.md)
...
```php
getPageOfBalancesV1($account_id, $limit, $limit_to_id, $offset): \criteo\api\retailmedia\v2027_01\Model\EntityResourceCollectionOutcomeBalanceV1AndMetadata
```
...
[**\criteo\api\retailmedia\v2027_01\Model\EntityResourceCollectionOutcomeBalanceV1AndMetadata**](../Model/EntityResourceCollectionOutcomeBalanceV1AndMetadata.md)
...
```php
updateBalanceV1($account_id, $balance_id, $value_resource_input_of_update_balance_model_v1): \criteo\api\retailmedia\v2027_01\Model\EntityResourceOutcomeOfBalanceResponseV1
```
...
$account_id = 'account_id_example'; // string | The account of the balance
$balance_id = 'balance_id_example'; // string | The balance to change the dates
$value_resource_input_of_update_balance_model_v1 = new \criteo\api\retailmedia\v2027_01\Model\ValueResourceInputOfUpdateBalanceModelV1(); // \criteo\api\retailmedia\v2027_01\Model\ValueResourceInputOfUpdateBalanceModelV1 | An object that represents the available options to modify a balance.
...
| **account_id** | **string**| The account of the balance | |
| **balance_id** | **string**| The balance to change the dates | |
| **value_resource_input_of_update_balance_model_v1** | [**\criteo\api\retailmedia\v2027_01\Model\ValueResourceInputOfUpdateBalanceModelV1**](../Model/ValueResourceInputOfUpdateBalanceModelV1.md)| An object that represents the available options to modify a balance. | |

### Return type

[**\criteo\api\retailmedia\v2027_01\Model\EntityResourceOutcomeOfBalanceResponseV1**](../Model/EntityResourceOutcomeOfBalanceResponseV1.md)
