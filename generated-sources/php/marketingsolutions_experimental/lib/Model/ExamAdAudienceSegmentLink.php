...
/**
 * ExamAdAudienceSegmentLink Class Doc Comment
 *
 * @category Class
 ...
 */
class ExamAdAudienceSegmentLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExamAdAudienceSegmentLink';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['audience_segment_id'] === null) {
            $invalidProperties[] = "'audience_segment_id' can't be null";
        }
     ...
     * Sets ad_id
     *
     * @param string $ad_id Unique ID of the Ad.
     *
     * @return self
     */
     ...
     *
     * @param string $audience_segment_id Unique ID of the Audience Segment.
     *
     * @return self
     */
