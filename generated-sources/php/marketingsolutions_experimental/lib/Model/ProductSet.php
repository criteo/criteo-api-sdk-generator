...
class ProductSet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets rules
     *
     * @return \criteo\api\marketingsolutions\experimental\Model\ProductSetRule[]
     */
     ...
     * Sets rules
     *
     * @param \criteo\api\marketingsolutions\experimental\Model\ProductSetRule[] $rules The rules identifying the product belonging to the set
     *
     * @return self
     */
