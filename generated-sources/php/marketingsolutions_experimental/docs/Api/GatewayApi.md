# criteo\api\marketingsolutions\experimental\GatewayApi
...
```php
getCurrentApplication(): \criteo\api\marketingsolutions\experimental\Model\ApplicationSummaryModelResponse
```
...
$apiInstance = new criteo\api\marketingsolutions\experimental\Api\GatewayApi(
...
[**\criteo\api\marketingsolutions\experimental\Model\ApplicationSummaryModelResponse**](../Model/ApplicationSummaryModelResponse.md)
