# criteo\api\marketingsolutions\experimental\AdvertiserApi
...
```php
listAdvertisers(): \criteo\api\marketingsolutions\experimental\Model\GetPortfolioResponse
```
...
$apiInstance = new criteo\api\marketingsolutions\experimental\Api\AdvertiserApi(
...
[**\criteo\api\marketingsolutions\experimental\Model\GetPortfolioResponse**](../Model/GetPortfolioResponse.md)
...
```php
listDatasetsByAdvertiser($advertiser_id): \criteo\api\marketingsolutions\experimental\Model\AdvertiserDatasetListResponse
```
...
[**\criteo\api\marketingsolutions\experimental\Model\AdvertiserDatasetListResponse**](../Model/AdvertiserDatasetListResponse.md)
...
```php
listIndustries(): \criteo\api\marketingsolutions\experimental\Model\ListAvailableIndustriesResponse
```
...
[**\criteo\api\marketingsolutions\experimental\Model\ListAvailableIndustriesResponse**](../Model/ListAvailableIndustriesResponse.md)
