...
**cost_of_goods_sold** | [**\criteo\api\marketingsolutions\experimental\Model\Price**](Price.md) |  | [optional]
**custom_attributes** | [**\criteo\api\marketingsolutions\experimental\Model\CustomAttribute[]**](CustomAttribute.md) | A list of custom (merchant-provided) attributes. This is useful for submitting attributes not explicitly exposed by the API. Declaring attributes explicitly exposed by the API using is forbidden | [optional]
...
**installment** | [**\criteo\api\marketingsolutions\experimental\Model\Installment**](Installment.md) |  | [optional]
...
**loyalty_points** | [**\criteo\api\marketingsolutions\experimental\Model\LoyaltyPoints**](LoyaltyPoints.md) |  | [optional]
...
**sale_price** | [**\criteo\api\marketingsolutions\experimental\Model\Price**](Price.md) |  | [optional]
...
**shipping** | [**\criteo\api\marketingsolutions\experimental\Model\ProductShipping[]**](ProductShipping.md) | Shipping rules. | [optional]
**shipping_height** | [**\criteo\api\marketingsolutions\experimental\Model\ProductShippingDimension**](ProductShippingDimension.md) |  | [optional]
**shipping_label** | **string** | The shipping label of the product, used to group product in account-level shipping rules. | [optional]
**shipping_length** | [**\criteo\api\marketingsolutions\experimental\Model\ProductShippingDimension**](ProductShippingDimension.md) |  | [optional]
**shipping_weight** | [**\criteo\api\marketingsolutions\experimental\Model\ProductShippingWeight**](ProductShippingWeight.md) |  | [optional]
**shipping_width** | [**\criteo\api\marketingsolutions\experimental\Model\ProductShippingDimension**](ProductShippingDimension.md) |  | [optional]
...
**taxes** | [**\criteo\api\marketingsolutions\experimental\Model\ProductTax[]**](ProductTax.md) | Tax information. | [optional]
...
**unit_pricing_base_measure** | [**\criteo\api\marketingsolutions\experimental\Model\ProductUnitPricingBaseMeasure**](ProductUnitPricingBaseMeasure.md) |  | [optional]
**unit_pricing_measure** | [**\criteo\api\marketingsolutions\experimental\Model\ProductUnitPricingMeasure**](ProductUnitPricingMeasure.md) |  | [optional]
