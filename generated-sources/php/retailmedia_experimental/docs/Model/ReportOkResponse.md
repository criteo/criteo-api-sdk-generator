...
------------ | ------------- | ------------- | -------------
**error_details** | [**\criteo\api\retailmedia\experimental\Model\ReportDetailErrors[]**](ReportDetailErrors.md) | The list of errors with details. |
...
**warning_details** | [**\criteo\api\retailmedia\experimental\Model\ReportDetailWarnings[]**](ReportDetailWarnings.md) | The list of Warnings with details. |
