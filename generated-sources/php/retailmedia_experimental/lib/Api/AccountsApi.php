...
/**
     ...
     * @return \criteo\api\retailmedia\experimental\Model\EntityResourceCollectionOutcomeOfRetailMediaChildAccountAndMetadata
     */
     ...
     * @throws \criteo\api\retailmedia\experimental\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\experimental\Model\EntityResourceCollectionOutcomeOfRetailMediaChildAccountAndMetadata, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPrivateMarketChildAccountsByAccountIdWithHttpInfo($account_id, $limit = 25, $offset = 0, string $contentType = self::contentTypes['getPrivateMarketChildAccountsByAccountId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\experimental\Model\EntityResourceCollectionOutcomeOfRetailMediaChildAccountAndMetadata' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\experimental\Model\EntityResourceCollectionOutcomeOfRetailMediaChildAccountAndMetadata' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\experimental\Model\EntityResourceCollectionOutcomeOfRetailMediaChildAccountAndMetadata', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\experimental\Model\EntityResourceCollectionOutcomeOfRetailMediaChildAccountAndMetadata';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\experimental\Model\EntityResourceCollectionOutcomeOfRetailMediaChildAccountAndMetadata',
    ...
    public function getPrivateMarketChildAccountsByAccountIdRequest($account_id, $limit = 25, $offset = 0, string $contentType = self::contentTypes['getPrivateMarketChildAccountsByAccountId'][0])
    {
        ...
        $resourcePath = '/experimental/retail-media/account-management/accounts/{accountId}/private-market-child-accounts';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  \criteo\api\retailmedia\experimental\Model\ValueResourceInputBrandIdSearchRequest $value_resource_input_brand_id_search_request BrandIdSearchRequest which contains the request parameters (optional)
     ...
     * @throws \criteo\api\retailmedia\experimental\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\experimental\Model\EntityResourceCollectionOutcomeBrandIdSearchResultPagingOffsetLimitMetadata
     */
     ...
     * @throws \criteo\api\retailmedia\experimental\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\experimental\Model\EntityResourceCollectionOutcomeBrandIdSearchResultPagingOffsetLimitMetadata, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchBrandsWithHttpInfo($limit = 25, $offset = 0, $value_resource_input_brand_id_search_request = null, string $contentType = self::contentTypes['searchBrands'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\experimental\Model\EntityResourceCollectionOutcomeBrandIdSearchResultPagingOffsetLimitMetadata' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\experimental\Model\EntityResourceCollectionOutcomeBrandIdSearchResultPagingOffsetLimitMetadata' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\experimental\Model\EntityResourceCollectionOutcomeBrandIdSearchResultPagingOffsetLimitMetadata', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\experimental\Model\EntityResourceCollectionOutcomeBrandIdSearchResultPagingOffsetLimitMetadata';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\experimental\Model\EntityResourceCollectionOutcomeBrandIdSearchResultPagingOffsetLimitMetadata',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function searchBrandsRequest($limit = 25, $offset = 0, $value_resource_input_brand_id_search_request = null, string $contentType = self::contentTypes['searchBrands'][0])
    {
        ...
        $resourcePath = '/experimental/retail-media/brands/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
