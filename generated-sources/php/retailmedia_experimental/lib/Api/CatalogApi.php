...
/**
     ...
     * @throws \criteo\api\retailmedia\experimental\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\experimental\Model\ReportOkResponse
     */
     ...
     * @throws \criteo\api\retailmedia\experimental\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\experimental\Model\ReportOkResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCatalogProductsBatchReportWithHttpInfo($operation_token, string $contentType = self::contentTypes['getCatalogProductsBatchReport'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\experimental\Model\ReportOkResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\experimental\Model\ReportOkResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\experimental\Model\ReportOkResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\experimental\Model\ReportOkResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\experimental\Model\ReportOkResponse',
    ...
    public function getCatalogProductsBatchReportRequest($operation_token, string $contentType = self::contentTypes['getCatalogProductsBatchReport'][0])
    {
        ...
        $resourcePath = '/experimental/retail-media/catalog/products/batch/report/{operation-token}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  \criteo\api\retailmedia\experimental\Model\ValueResourceInputSetProductBuyBoxWinnersRequest $value_resource_input_set_product_buy_box_winners_request Updated buy box winners for one or more products (required)
    ...
    public function offerSetBbwV1Request($retailer_id, $value_resource_input_set_product_buy_box_winners_request, string $contentType = self::contentTypes['offerSetBbwV1'][0])
    {
        ...
        $resourcePath = '/experimental/retail-media/retailers/{retailer-id}/products/set-buy-box-winners';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  \criteo\api\retailmedia\experimental\Model\ValueResourceInputUpdateOffersRequest $value_resource_input_update_offers_request Collection of offer price and availability updates to be applied. (required)
    ...
    public function offerUpdateV1Request($retailer_id, $value_resource_input_update_offers_request, string $contentType = self::contentTypes['offerUpdateV1'][0])
    {
        ...
        $resourcePath = '/experimental/retail-media/retailers/{retailer-id}/offers/update';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \criteo\api\retailmedia\experimental\Model\ProductsCustomBatchRequest $products_custom_batch_request products_custom_batch_request (required)
     ...
     * @throws \criteo\api\retailmedia\experimental\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\experimental\Model\BatchAcceptedResponse
     */
     ...
     * /experimental/retail-media/catalog/products/batch
     *
     * @param  \criteo\api\retailmedia\experimental\Model\ProductsCustomBatchRequest $products_custom_batch_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['submitCatalogProductsBatch'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\experimental\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\experimental\Model\BatchAcceptedResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function submitCatalogProductsBatchWithHttpInfo($products_custom_batch_request, string $contentType = self::contentTypes['submitCatalogProductsBatch'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 202:
                    if ('\criteo\api\retailmedia\experimental\Model\BatchAcceptedResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\experimental\Model\BatchAcceptedResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\experimental\Model\BatchAcceptedResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\experimental\Model\BatchAcceptedResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 202:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\experimental\Model\BatchAcceptedResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function submitCatalogProductsBatchRequest($products_custom_batch_request, string $contentType = self::contentTypes['submitCatalogProductsBatch'][0])
    {
        ...
        $resourcePath = '/experimental/retail-media/catalog/products/batch';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
