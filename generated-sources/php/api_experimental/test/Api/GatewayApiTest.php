...
use criteo\api\api\experimental\Api\GatewayApi;
use criteo\api\api\experimental\ClientCredentialsClient;
use criteo\api\api\experimental\ApiException;
use criteo\api\api\experimental\ObjectSerializer;
use criteo\api\api\experimental\test\ExampleApplication;
...
class GatewayApiTest extends TestCase
{
    ...
    function __construct()
    {
        ...
        $this->clientId = $_SERVER["API_TEST_CLIENT_ID"];
        $this->clientSecret = $_SERVER["API_TEST_CLIENT_SECRET"];
        $this->applicationId = (int) $_SERVER["API_TEST_APPLICATION_ID"];
    }
        ...
        $this->assertThrows(ApiException::class,
            ...
            function($exception) {
                $data = ObjectSerializer::deserialize(
                    ...
                    '\criteo\api\api\experimental\Model\ApplicationSummaryModelResponse',
