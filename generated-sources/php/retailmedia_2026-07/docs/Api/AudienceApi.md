# criteo\api\retailmedia\v2026_07\AudienceApi
...
```php
addRemoveContactListByAudienceSegment($audience_segment_id, $retail_media_contactlist_amendment_request): \criteo\api\retailmedia\v2026_07\Model\RetailMediaContactlistOperation
```
...
$apiInstance = new criteo\api\retailmedia\v2026_07\Api\AudienceApi(
...
$retail_media_contactlist_amendment_request = new \criteo\api\retailmedia\v2026_07\Model\RetailMediaContactlistAmendmentRequest(); // \criteo\api\retailmedia\v2026_07\Model\RetailMediaContactlistAmendmentRequest
...
| **retail_media_contactlist_amendment_request** | [**\criteo\api\retailmedia\v2026_07\Model\RetailMediaContactlistAmendmentRequest**](../Model/RetailMediaContactlistAmendmentRequest.md)|  | |

### Return type

[**\criteo\api\retailmedia\v2026_07\Model\RetailMediaContactlistOperation**](../Model/RetailMediaContactlistOperation.md)
...
```php
bulkCreateAudienceSegments($account_id, $rm_audience_segment_bulk_create_input_v1): \criteo\api\retailmedia\v2026_07\Model\RmAudienceSegmentEntityV1ListResponse
```
...
$rm_audience_segment_bulk_create_input_v1 = new \criteo\api\retailmedia\v2026_07\Model\RmAudienceSegmentBulkCreateInputV1(); // \criteo\api\retailmedia\v2026_07\Model\RmAudienceSegmentBulkCreateInputV1 | Segment creation parameter
...
| **rm_audience_segment_bulk_create_input_v1** | [**\criteo\api\retailmedia\v2026_07\Model\RmAudienceSegmentBulkCreateInputV1**](../Model/RmAudienceSegmentBulkCreateInputV1.md)| Segment creation parameter | |

### Return type

[**\criteo\api\retailmedia\v2026_07\Model\RmAudienceSegmentEntityV1ListResponse**](../Model/RmAudienceSegmentEntityV1ListResponse.md)
...
```php
bulkDeleteAudienceSegments($account_id, $rm_audience_segment_bulk_delete_input_v1): \criteo\api\retailmedia\v2026_07\Model\RmAudienceSegmentIdEntityV1ListResponse
```
...
$account_id = 'account_id_example'; // string | Account id
$rm_audience_segment_bulk_delete_input_v1 = new \criteo\api\retailmedia\v2026_07\Model\RmAudienceSegmentBulkDeleteInputV1(); // \criteo\api\retailmedia\v2026_07\Model\RmAudienceSegmentBulkDeleteInputV1 | Segment delete request.
...
| ------------- | ------------- | ------------- | ------------- |
| **account_id** | **string**| Account id | |
| **rm_audience_segment_bulk_delete_input_v1** | [**\criteo\api\retailmedia\v2026_07\Model\RmAudienceSegmentBulkDeleteInputV1**](../Model/RmAudienceSegmentBulkDeleteInputV1.md)| Segment delete request. | |

### Return type

[**\criteo\api\retailmedia\v2026_07\Model\RmAudienceSegmentIdEntityV1ListResponse**](../Model/RmAudienceSegmentIdEntityV1ListResponse.md)
...
```php
bulkUpdateAudienceSegments($account_id, $rm_audience_segment_bulk_update_input_v1): \criteo\api\retailmedia\v2026_07\Model\RmAudienceSegmentEntityV1ListResponse
```
...
$account_id = 'account_id_example'; // string | Account id
$rm_audience_segment_bulk_update_input_v1 = new \criteo\api\retailmedia\v2026_07\Model\RmAudienceSegmentBulkUpdateInputV1(); // \criteo\api\retailmedia\v2026_07\Model\RmAudienceSegmentBulkUpdateInputV1 | Segment Update request
...
| ------------- | ------------- | ------------- | ------------- |
| **account_id** | **string**| Account id | |
| **rm_audience_segment_bulk_update_input_v1** | [**\criteo\api\retailmedia\v2026_07\Model\RmAudienceSegmentBulkUpdateInputV1**](../Model/RmAudienceSegmentBulkUpdateInputV1.md)| Segment Update request | |
...
```php
getAudienceSegmentContactListStatistics($account_id, $audience_segment_id): \criteo\api\retailmedia\v2026_07\Model\RmContactListStatisticsEntityV1Response
```
...
[**\criteo\api\retailmedia\v2026_07\Model\RmContactListStatisticsEntityV1Response**](../Model/RmContactListStatisticsEntityV1Response.md)
...
```php
searchAudienceSegments($account_id, $rm_audience_segment_search_input_v1, $limit, $offset): \criteo\api\retailmedia\v2026_07\Model\RmAudienceSegmentEntityV1RmAudienceSegmentSearchMetadataV1ListResponse
```
...
$account_id = 'account_id_example'; // string | Account Id
$rm_audience_segment_search_input_v1 = new \criteo\api\retailmedia\v2026_07\Model\RmAudienceSegmentSearchInputV1(); // \criteo\api\retailmedia\v2026_07\Model\RmAudienceSegmentSearchInputV1 | Segment search filters.
...
| ------------- | ------------- | ------------- | ------------- |
| **account_id** | **string**| Account Id | |
| **rm_audience_segment_search_input_v1** | [**\criteo\api\retailmedia\v2026_07\Model\RmAudienceSegmentSearchInputV1**](../Model/RmAudienceSegmentSearchInputV1.md)| Segment search filters. | |
...
[**\criteo\api\retailmedia\v2026_07\Model\RmAudienceSegmentEntityV1RmAudienceSegmentSearchMetadataV1ListResponse**](../Model/RmAudienceSegmentEntityV1RmAudienceSegmentSearchMetadataV1ListResponse.md)
...
```php
searchAudiences($account_id, $rm_audience_search_input_v1, $limit, $offset): \criteo\api\retailmedia\v2026_07\Model\RmAudienceEntityV1RmAudienceSearchMetadataV1ListResponse
```
...
$account_id = 'account_id_example'; // string | Account Id
$rm_audience_search_input_v1 = new \criteo\api\retailmedia\v2026_07\Model\RmAudienceSearchInputV1(); // \criteo\api\retailmedia\v2026_07\Model\RmAudienceSearchInputV1 | Audience search filters.
$limit = 50; // int | The number of elements to be returned. The default is 50 and the maximum is 500.
$offset = 0; // int | The (zero-based) offset into the collection. The default is 0.
...
| ------------- | ------------- | ------------- | ------------- |
| **account_id** | **string**| Account Id | |
| **rm_audience_search_input_v1** | [**\criteo\api\retailmedia\v2026_07\Model\RmAudienceSearchInputV1**](../Model/RmAudienceSearchInputV1.md)| Audience search filters. | |
| **limit** | **int**| The number of elements to be returned. The default is 50 and the maximum is 500. | [optional] [default to 50] |
| **offset** | **int**| The (zero-based) offset into the collection. The default is 0. | [optional] [default to 0] |

### Return type

[**\criteo\api\retailmedia\v2026_07\Model\RmAudienceEntityV1RmAudienceSearchMetadataV1ListResponse**](../Model/RmAudienceEntityV1RmAudienceSearchMetadataV1ListResponse.md)
