# criteo\api\retailmedia\v2026_07\BillingApi
...
```php
createPartnerBillingReportRequestV1($value_resource_input_partner_billing_report_request_v1): \criteo\api\retailmedia\v2026_07\Model\EntityResourceOutcomePartnerBillingReportStatusV1
```
...
$apiInstance = new criteo\api\retailmedia\v2026_07\Api\BillingApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$value_resource_input_partner_billing_report_request_v1 = new \criteo\api\retailmedia\v2026_07\Model\ValueResourceInputPartnerBillingReportRequestV1(); // \criteo\api\retailmedia\v2026_07\Model\ValueResourceInputPartnerBillingReportRequestV1 | Partner Billing Report request object.
...
| ------------- | ------------- | ------------- | ------------- |
| **value_resource_input_partner_billing_report_request_v1** | [**\criteo\api\retailmedia\v2026_07\Model\ValueResourceInputPartnerBillingReportRequestV1**](../Model/ValueResourceInputPartnerBillingReportRequestV1.md)| Partner Billing Report request object. | |

### Return type

[**\criteo\api\retailmedia\v2026_07\Model\EntityResourceOutcomePartnerBillingReportStatusV1**](../Model/EntityResourceOutcomePartnerBillingReportStatusV1.md)
...
```php
getPartnerBillingReportStatusV1($request_id): \criteo\api\retailmedia\v2026_07\Model\EntityResourceOutcomePartnerBillingReportStatusV1
```
