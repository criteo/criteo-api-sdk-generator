...
/**
     ...
     *
     * @param  \criteo\api\retailmedia\v2026_07\Model\ValueResourceInputPartnerBillingReportRequestV1 $value_resource_input_partner_billing_report_request_v1 Partner Billing Report request object. (required)
     ...
     * @return \criteo\api\retailmedia\v2026_07\Model\EntityResourceOutcomePartnerBillingReportStatusV1
     */
     ...
     * @throws \criteo\api\retailmedia\v2026_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2026_07\Model\EntityResourceOutcomePartnerBillingReportStatusV1, HTTP status code, HTTP response headers (array of strings)
     */
    public function createPartnerBillingReportRequestV1WithHttpInfo($value_resource_input_partner_billing_report_request_v1, string $contentType = self::contentTypes['createPartnerBillingReportRequestV1'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\criteo\api\retailmedia\v2026_07\Model\EntityResourceOutcomePartnerBillingReportStatusV1' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2026_07\Model\EntityResourceOutcomePartnerBillingReportStatusV1' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2026_07\Model\EntityResourceOutcomePartnerBillingReportStatusV1', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2026_07\Model\EntityResourceOutcomePartnerBillingReportStatusV1';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2026_07\Model\EntityResourceOutcomePartnerBillingReportStatusV1',
    ...
    public function createPartnerBillingReportRequestV1Request($value_resource_input_partner_billing_report_request_v1, string $contentType = self::contentTypes['createPartnerBillingReportRequestV1'][0])
    {
        ...
        $resourcePath = '/2026-07/retail-media/billing/partner-report';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getPartnerBillingReportOutputV1Request($request_id, string $contentType = self::contentTypes['getPartnerBillingReportOutputV1'][0])
    {
        ...
        $resourcePath = '/2026-07/retail-media/billing/partner-report/{requestId}/output';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getPartnerBillingReportStatusV1Request($request_id, string $contentType = self::contentTypes['getPartnerBillingReportStatusV1'][0])
    {
        ...
        $resourcePath = '/2026-07/retail-media/billing/partner-report/{requestId}/status';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
