...
/**
     ...
     *
     * @param  \criteo\api\retailmedia\v2026_07\Model\ValueResourceInputAccountFeesSearchRequest $value_resource_input_account_fees_search_request value_resource_input_account_fees_search_request (required)
     ...
     * @return \criteo\api\retailmedia\v2026_07\Model\ValueResourceCollectionOutcomePrivateMarketAccountFeesAndMetadata
     */
     ...
     * /2026-07/retail-media/accounts/fees/search
     *
     * @param  \criteo\api\retailmedia\v2026_07\Model\ValueResourceInputAccountFeesSearchRequest $value_resource_input_account_fees_search_request (required)
     * @param  int $limit used for paging, number of results returned per request, Maximum of 500 (optional, default to 50)
     * @param  int $offset used for paging, number of records to skip (optional, default to 0)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['accountFeesSearch'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\v2026_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2026_07\Model\ValueResourceCollectionOutcomePrivateMarketAccountFeesAndMetadata, HTTP status code, HTTP response headers (array of strings)
     */
    public function accountFeesSearchWithHttpInfo($value_resource_input_account_fees_search_request, $limit = 50, $offset = 0, string $contentType = self::contentTypes['accountFeesSearch'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2026_07\Model\ValueResourceCollectionOutcomePrivateMarketAccountFeesAndMetadata' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2026_07\Model\ValueResourceCollectionOutcomePrivateMarketAccountFeesAndMetadata' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2026_07\Model\ValueResourceCollectionOutcomePrivateMarketAccountFeesAndMetadata', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2026_07\Model\ValueResourceCollectionOutcomePrivateMarketAccountFeesAndMetadata';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2026_07\Model\ValueResourceCollectionOutcomePrivateMarketAccountFeesAndMetadata',
    ...
    public function accountFeesSearchRequest($value_resource_input_account_fees_search_request, $limit = 50, $offset = 0, string $contentType = self::contentTypes['accountFeesSearch'][0])
    {
        ...
        $resourcePath = '/2026-07/retail-media/accounts/fees/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  \criteo\api\retailmedia\v2026_07\Model\ValueResourceInputOfRetailMediaBrands $value_resource_input_of_retail_media_brands value_resource_input_of_retail_media_brands (optional)
     ...
     * @throws \criteo\api\retailmedia\v2026_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2026_07\Model\ValueResourceOutcomeOfRetailMediaBrands
     */
     ...
     *
     * @param  string $account_id the account id to update (required)
     * @param  \criteo\api\retailmedia\v2026_07\Model\ValueResourceInputOfRetailMediaBrands $value_resource_input_of_retail_media_brands (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['addBrands'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\v2026_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2026_07\Model\ValueResourceOutcomeOfRetailMediaBrands, HTTP status code, HTTP response headers (array of strings)
     */
    public function addBrandsWithHttpInfo($account_id, $value_resource_input_of_retail_media_brands = null, string $contentType = self::contentTypes['addBrands'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2026_07\Model\ValueResourceOutcomeOfRetailMediaBrands' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2026_07\Model\ValueResourceOutcomeOfRetailMediaBrands' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2026_07\Model\ValueResourceOutcomeOfRetailMediaBrands', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2026_07\Model\ValueResourceOutcomeOfRetailMediaBrands';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2026_07\Model\ValueResourceOutcomeOfRetailMediaBrands',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function addBrandsRequest($account_id, $value_resource_input_of_retail_media_brands = null, string $contentType = self::contentTypes['addBrands'][0])
    {
        ...
        $resourcePath = '/2026-07/retail-media/account-management/accounts/{accountId}/brands/add';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  \criteo\api\retailmedia\v2026_07\Model\ValueResourceInputOfRetailMediaBrandAccountCreation $value_resource_input_of_retail_media_brand_account_creation value_resource_input_of_retail_media_brand_account_creation (optional)
     ...
     * @throws \criteo\api\retailmedia\v2026_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2026_07\Model\EntityResourceOutcomeOfRetailMediaAccount
     */
     ...
     *
     * @param  string $account_id The given account id (required)
     * @param  \criteo\api\retailmedia\v2026_07\Model\ValueResourceInputOfRetailMediaBrandAccountCreation $value_resource_input_of_retail_media_brand_account_creation (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createPrivateMarketDemandBrandAccount'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\v2026_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2026_07\Model\EntityResourceOutcomeOfRetailMediaAccount, HTTP status code, HTTP response headers (array of strings)
     */
    public function createPrivateMarketDemandBrandAccountWithHttpInfo($account_id, $value_resource_input_of_retail_media_brand_account_creation = null, string $contentType = self::contentTypes['createPrivateMarketDemandBrandAccount'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\criteo\api\retailmedia\v2026_07\Model\EntityResourceOutcomeOfRetailMediaAccount' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2026_07\Model\EntityResourceOutcomeOfRetailMediaAccount' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2026_07\Model\EntityResourceOutcomeOfRetailMediaAccount', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2026_07\Model\EntityResourceOutcomeOfRetailMediaAccount';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2026_07\Model\EntityResourceOutcomeOfRetailMediaAccount',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function createPrivateMarketDemandBrandAccountRequest($account_id, $value_resource_input_of_retail_media_brand_account_creation = null, string $contentType = self::contentTypes['createPrivateMarketDemandBrandAccount'][0])
    {
        ...
        $resourcePath = '/2026-07/retail-media/account-management/accounts/{accountId}/create-brand-account';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $account_id The given account id (required)
     * @param  \criteo\api\retailmedia\v2026_07\Model\ValueResourceInputOfRetailMediaSellerAccountCreation $value_resource_input_of_retail_media_seller_account_creation value_resource_input_of_retail_media_seller_account_creation (optional)
     ...
     *
     * @param  string $account_id The given account id (required)
     * @param  \criteo\api\retailmedia\v2026_07\Model\ValueResourceInputOfRetailMediaSellerAccountCreation $value_resource_input_of_retail_media_seller_account_creation (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createPrivateMarketDemandSellerAccount'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\v2026_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function createPrivateMarketDemandSellerAccountRequest($account_id, $value_resource_input_of_retail_media_seller_account_creation = null, string $contentType = self::contentTypes['createPrivateMarketDemandSellerAccount'][0])
    {
        ...
        $resourcePath = '/2026-07/retail-media/account-management/accounts/{accountId}/create-seller-account';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2026_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2026_07\Model\JsonApiPageResponseOfAccount
     */
     ...
     * @throws \criteo\api\retailmedia\v2026_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2026_07\Model\JsonApiPageResponseOfAccount, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAccountsWithHttpInfo($limit_to_id = null, $page_index = 0, $page_size = 25, string $contentType = self::contentTypes['getAccounts'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2026_07\Model\JsonApiPageResponseOfAccount' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2026_07\Model\JsonApiPageResponseOfAccount' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2026_07\Model\JsonApiPageResponseOfAccount', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2026_07\Model\JsonApiPageResponseOfAccount';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2026_07\Model\JsonApiPageResponseOfAccount',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getAccountsRequest($limit_to_id = null, $page_index = 0, $page_size = 25, string $contentType = self::contentTypes['getAccounts'][0])
    {
        ...
        $resourcePath = '/2026-07/retail-media/accounts';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\retailmedia\v2026_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2026_07\Model\EntityResourceCollectionOutcomeOfRetailMediaChildAccountAndMetadata
     */
     ...
     * @throws \criteo\api\retailmedia\v2026_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2026_07\Model\EntityResourceCollectionOutcomeOfRetailMediaChildAccountAndMetadata, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPrivateMarketChildAccountsByAccountIdWithHttpInfo($account_id, $limit = 25, $offset = 0, string $contentType = self::contentTypes['getPrivateMarketChildAccountsByAccountId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2026_07\Model\EntityResourceCollectionOutcomeOfRetailMediaChildAccountAndMetadata' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2026_07\Model\EntityResourceCollectionOutcomeOfRetailMediaChildAccountAndMetadata' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2026_07\Model\EntityResourceCollectionOutcomeOfRetailMediaChildAccountAndMetadata', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2026_07\Model\EntityResourceCollectionOutcomeOfRetailMediaChildAccountAndMetadata';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2026_07\Model\EntityResourceCollectionOutcomeOfRetailMediaChildAccountAndMetadata',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getPrivateMarketChildAccountsByAccountIdRequest($account_id, $limit = 25, $offset = 0, string $contentType = self::contentTypes['getPrivateMarketChildAccountsByAccountId'][0])
    {
        ...
        $resourcePath = '/2026-07/retail-media/account-management/accounts/{accountId}/private-market-child-accounts';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  \criteo\api\retailmedia\v2026_07\Model\GrantConsentInput $grant_consent_input grant_consent_input (optional)
     ...
     *
     * @param  string $account_id The demand account ID on which to grant consent (required)
     * @param  \criteo\api\retailmedia\v2026_07\Model\GrantConsentInput $grant_consent_input (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['grantConsent'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\v2026_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function grantConsentRequest($account_id, $grant_consent_input = null, string $contentType = self::contentTypes['grantConsent'][0])
    {
        ...
        $resourcePath = '/2026-07/retail-media/accounts/{accountId}/grant-consent';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function removeBrandsRequest($account_id, $value_resource_input_of_retail_media_brands = null, string $contentType = self::contentTypes['removeBrands'][0])
    {
        ...
        $resourcePath = '/2026-07/retail-media/account-management/accounts/{accountId}/brands/remove';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  \criteo\api\retailmedia\v2026_07\Model\ValueResourceInputBrandIdSearchRequest $value_resource_input_brand_id_search_request BrandIdSearchRequest which contains the request parameters (optional)
     ...
     * @throws \criteo\api\retailmedia\v2026_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2026_07\Model\EntityResourceCollectionOutcomeBrandIdSearchResultPagingOffsetLimitMetadata
     */
     ...
     * @throws \criteo\api\retailmedia\v2026_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2026_07\Model\EntityResourceCollectionOutcomeBrandIdSearchResultPagingOffsetLimitMetadata, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchBrandsWithHttpInfo($limit = 25, $offset = 0, $value_resource_input_brand_id_search_request = null, string $contentType = self::contentTypes['searchBrands'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2026_07\Model\EntityResourceCollectionOutcomeBrandIdSearchResultPagingOffsetLimitMetadata' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2026_07\Model\EntityResourceCollectionOutcomeBrandIdSearchResultPagingOffsetLimitMetadata' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2026_07\Model\EntityResourceCollectionOutcomeBrandIdSearchResultPagingOffsetLimitMetadata', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2026_07\Model\EntityResourceCollectionOutcomeBrandIdSearchResultPagingOffsetLimitMetadata';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2026_07\Model\EntityResourceCollectionOutcomeBrandIdSearchResultPagingOffsetLimitMetadata',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function searchBrandsRequest($limit = 25, $offset = 0, $value_resource_input_brand_id_search_request = null, string $contentType = self::contentTypes['searchBrands'][0])
    {
        ...
        $resourcePath = '/2026-07/retail-media/brands/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \criteo\api\retailmedia\v2026_07\Model\ValueResourceInputOfSellerSearch $value_resource_input_of_seller_search  (required)
     ...
     * @throws \criteo\api\retailmedia\v2026_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2026_07\Model\ValueResourceCollectionOutcomeOfSellerSearchResult
     */
     ...
     * @throws \criteo\api\retailmedia\v2026_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2026_07\Model\ValueResourceCollectionOutcomeOfSellerSearchResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchSellersWithHttpInfo($value_resource_input_of_seller_search, string $contentType = self::contentTypes['searchSellers'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2026_07\Model\ValueResourceCollectionOutcomeOfSellerSearchResult' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2026_07\Model\ValueResourceCollectionOutcomeOfSellerSearchResult' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2026_07\Model\ValueResourceCollectionOutcomeOfSellerSearchResult', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2026_07\Model\ValueResourceCollectionOutcomeOfSellerSearchResult';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2026_07\Model\ValueResourceCollectionOutcomeOfSellerSearchResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function searchSellersRequest($value_resource_input_of_seller_search, string $contentType = self::contentTypes['searchSellers'][0])
    {
        ...
        $resourcePath = '/2026-07/retail-media/accounts/sellers/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \criteo\api\retailmedia\v2026_07\Model\ValueResourceInputAccountFeesUpdateRequest $value_resource_input_account_fees_update_request value_resource_input_account_fees_update_request (required)
     ...
     * /2026-07/retail-media/accounts/fees/update
     *
     * @param  \criteo\api\retailmedia\v2026_07\Model\ValueResourceInputAccountFeesUpdateRequest $value_resource_input_account_fees_update_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateAccountFees'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\v2026_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function updateAccountFeesRequest($value_resource_input_account_fees_update_request, string $contentType = self::contentTypes['updateAccountFees'][0])
    {
        ...
        $resourcePath = '/2026-07/retail-media/accounts/fees/update';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $account_id The given account id (required)
     * @param  \criteo\api\retailmedia\v2026_07\Model\ValueResourceCollectionInputOfRetailMediaSeller $value_resource_collection_input_of_retail_media_seller value_resource_collection_input_of_retail_media_seller (required)
     ...
     * @throws \criteo\api\retailmedia\v2026_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\retailmedia\v2026_07\Model\ValueResourceCollectionOutcomeOfRetailMediaSeller
     */
     ...
     *
     * @param  string $account_id The given account id (required)
     * @param  \criteo\api\retailmedia\v2026_07\Model\ValueResourceCollectionInputOfRetailMediaSeller $value_resource_collection_input_of_retail_media_seller (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateSellers'] to see the possible values for this operation
     *
     * @throws \criteo\api\retailmedia\v2026_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\retailmedia\v2026_07\Model\ValueResourceCollectionOutcomeOfRetailMediaSeller, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateSellersWithHttpInfo($account_id, $value_resource_collection_input_of_retail_media_seller, string $contentType = self::contentTypes['updateSellers'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\retailmedia\v2026_07\Model\ValueResourceCollectionOutcomeOfRetailMediaSeller' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2026_07\Model\ValueResourceCollectionOutcomeOfRetailMediaSeller' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2026_07\Model\ValueResourceCollectionOutcomeOfRetailMediaSeller', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\retailmedia\v2026_07\Model\ValueResourceCollectionOutcomeOfRetailMediaSeller';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2026_07\Model\ValueResourceCollectionOutcomeOfRetailMediaSeller',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function updateSellersRequest($account_id, $value_resource_collection_input_of_retail_media_seller, string $contentType = self::contentTypes['updateSellers'][0])
    {
        ...
        $resourcePath = '/2026-07/retail-media/account-management/accounts/{accountId}/sellers';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
