...
/**
    ...
    public function createPartnerBillingReportRequestV1WithHttpInfo($value_resource_input_partner_billing_report_request_v1, string $contentType = self::contentTypes['createPartnerBillingReportRequestV1'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\criteo\api\retailmedia\v2026_01\Model\EntityResourceOutcomePartnerBillingReportStatusV1' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\retailmedia\v2026_01\Model\EntityResourceOutcomePartnerBillingReportStatusV1' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\retailmedia\v2026_01\Model\EntityResourceOutcomePartnerBillingReportStatusV1', []),
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\retailmedia\v2026_01\Model\EntityResourceOutcomePartnerBillingReportStatusV1',
    ...
    public function getPartnerBillingReportOutputV1Request($request_id, string $contentType = self::contentTypes['getPartnerBillingReportOutputV1'][0])
    {
        ...
        $resourcePath = '/2026-01/retail-media/billing/partner-report/{requestId}/output';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getPartnerBillingReportStatusV1Request($request_id, string $contentType = self::contentTypes['getPartnerBillingReportStatusV1'][0])
    {
        ...
        $resourcePath = '/2026-01/retail-media/billing/partner-report/{requestId}/status';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
