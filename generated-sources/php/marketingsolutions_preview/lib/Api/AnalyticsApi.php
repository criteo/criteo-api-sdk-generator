...
/**
     ...
     *
     * @param  \criteo\api\marketingsolutions\preview\Model\GenerateAllProductsReportRequestAttributesRequest $generate_all_products_report_request_attributes_request The all-products report export request. (optional)
    ...
    public function createAllProductsExportRequest($generate_all_products_report_request_attributes_request = null, string $contentType = self::contentTypes['createAllProductsExport'][0])
    {
        ...
        $resourcePath = '/preview/marketing-solutions/report/products/export';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function downloadAllProductsExportRequest($report_id, string $contentType = self::contentTypes['downloadAllProductsExport'][0])
    {
        ...
        $resourcePath = '/preview/marketing-solutions/report/products/{reportId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getExportStatusRequest($report_id, string $contentType = self::contentTypes['getExportStatus'][0])
    {
        ...
        $resourcePath = '/preview/marketing-solutions/report-jobs/{reportId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
