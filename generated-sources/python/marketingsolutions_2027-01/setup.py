...
```sh
pip install criteo-api-marketingsolutions-sdk==2027.01.0.260731
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-marketingsolutions-sdk==2027.01.0.260731`)

Then import the package:
```python
import criteo_api_marketingsolutions_v2027_01
```
