...
```sh
pip install criteo-api-retailmedia-sdk==2026.01.0.260731
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-retailmedia-sdk==2026.01.0.260731`)
