...
from criteo_api_retailmedia_experimental import rest
from criteo_api_retailmedia_experimental.configuration import Configuration
from criteo_api_retailmedia_experimental.exceptions import ApiTypeError, ApiValueError, ApiException
from criteo_api_retailmedia_experimental.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/0.0.260803/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_private_market_child_accounts_by_account_id  # this is an instance of the class Endpoint
        api_instance.get_private_market_child_accounts_by_account_id()  # this invokes api_instance.get_private_market_child_accounts_by_account_id.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_private_market_child_accounts_by_account_id.callable or self.callable in this class
