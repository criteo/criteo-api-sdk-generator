...
------------ | ------------- | ------------- | -------------
*GatewayApi* | [**get_current_application**](docs/GatewayApi.md#get_current_application) | **GET** /2027-01/commerce-grid/me | /2027-01/commerce-grid/me
*SegmentApi* | [**add_remove_contact_list_by_audience_segment**](docs/SegmentApi.md#add_remove_contact_list_by_audience_segment) | **POST** /2027-01/commerce-grid/audience-segments/{audience-segment-id}/contact-list/add-remove | /2027-01/commerce-grid/audience-segments/{audience-segment-id}/contact-list/add-remove
*SegmentApi* | [**bulk_create_audience_segments**](docs/SegmentApi.md#bulk_create_audience_segments) | **POST** /2027-01/commerce-grid/audience-segments/create | /2027-01/commerce-grid/audience-segments/create
*SegmentApi* | [**bulk_delete_audience_segments**](docs/SegmentApi.md#bulk_delete_audience_segments) | **POST** /2027-01/commerce-grid/audience-segments/delete | /2027-01/commerce-grid/audience-segments/delete
*SegmentApi* | [**bulk_update_audience_segments**](docs/SegmentApi.md#bulk_update_audience_segments) | **PATCH** /2027-01/commerce-grid/audience-segments | /2027-01/commerce-grid/audience-segments
*SegmentApi* | [**clear_contact_list_by_audience_segment**](docs/SegmentApi.md#clear_contact_list_by_audience_segment) | **POST** /2027-01/commerce-grid/audience-segments/{audience-segment-id}/contact-list/clear | /2027-01/commerce-grid/audience-segments/{audience-segment-id}/contact-list/clear
*SegmentApi* | [**get_audience_segment_contact_list_statistics**](docs/SegmentApi.md#get_audience_segment_contact_list_statistics) | **GET** /2027-01/commerce-grid/audience-segments/{audience-segment-id}/contact-list/statistics | /2027-01/commerce-grid/audience-segments/{audience-segment-id}/contact-list/statistics
*SegmentApi* | [**search_audience_segments**](docs/SegmentApi.md#search_audience_segments) | **POST** /2027-01/commerce-grid/audience-segments/search | /2027-01/commerce-grid/audience-segments/search
