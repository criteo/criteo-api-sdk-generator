...
```sh
pip install criteo-api-commercegrid-sdk==2026.07.0.260803
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-commercegrid-sdk==2026.07.0.260803`)
