...
```sh
pip install criteo-api-commercegrid-sdk==2026.07.0.260731
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-commercegrid-sdk==2026.07.0.260731`)

Then import the package:
```python
import criteo_api_commercegrid_v2026_07
```
