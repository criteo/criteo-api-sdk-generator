...
```sh
pip install criteo-api-commercegrid-sdk==0.0.260803
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-commercegrid-sdk==0.0.260803`)

Then import the package:
```python
import criteo_api_commercegrid_experimental
```
