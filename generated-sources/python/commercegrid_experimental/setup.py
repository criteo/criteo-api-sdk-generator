...
```sh
pip install criteo-api-commercegrid-sdk==0.0.260731
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-commercegrid-sdk==0.0.260731`)
