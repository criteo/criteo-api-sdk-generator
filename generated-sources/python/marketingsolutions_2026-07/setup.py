...
```sh
pip install criteo-api-marketingsolutions-sdk==2026.07.0.260803
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-marketingsolutions-sdk==2026.07.0.260803`)

Then import the package:
```python
import criteo_api_marketingsolutions_v2026_07
```
