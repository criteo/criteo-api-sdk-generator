...
import com.criteo.api.marketingsolutions.v2027_01.model.AdLevelReportRequestAttributesRequest;
import java.io.File;
import com.criteo.api.marketingsolutions.v2027_01.model.PlacementsReportQueryMessageListRequest;
import com.criteo.api.marketingsolutions.v2027_01.model.StatisticsReportQueryMessage;
import com.criteo.api.marketingsolutions.v2027_01.model.TransactionsReportQueryMessageListRequest;
import com.criteo.api.marketingsolutions.v2027_01.model.TransparencyQueryMessage;
import com.criteo.api.marketingsolutions.v2027_01.model.TransparencyReportListResponse;
...
public class AnalyticsApi {
    ...
    /**
     * Build call for getAdLevelReport
     * @param adLevelReportRequestAttributesRequest  (optional)
     ...
     */
    public okhttp3.Call getAdLevelReportCall(AdLevelReportRequestAttributesRequest adLevelReportRequestAttributesRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = adLevelReportRequestAttributesRequest;

        // create path and map variables
        String localVarPath = "/2027-01/marketing-solutions/statistics-adlevel/report";
    ...
    private okhttp3.Call getAdLevelReportValidateBeforeCall(AdLevelReportRequestAttributesRequest adLevelReportRequestAttributesRequest, final ApiCallback _callback) throws ApiException {
        return getAdLevelReportCall(adLevelReportRequestAttributesRequest, _callback);
     ...
     */
    public File getAdLevelReport(AdLevelReportRequestAttributesRequest adLevelReportRequestAttributesRequest) throws ApiException {
        ApiResponse<File> localVarResp = getAdLevelReportWithHttpInfo(adLevelReportRequestAttributesRequest);
     ...
     */
    public ApiResponse<File> getAdLevelReportWithHttpInfo(AdLevelReportRequestAttributesRequest adLevelReportRequestAttributesRequest) throws ApiException {
        okhttp3.Call localVarCall = getAdLevelReportValidateBeforeCall(adLevelReportRequestAttributesRequest, null);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * /2027-01/marketing-solutions/statistics-adlevel/report (asynchronously)
     * Generates a synchronous ad-level report (currently OpenAI campaigns only, with Open Web planned) returned directly in the response as JSON or CSV — no job creation, polling, or separate download step.  &lt;br/&gt;&lt;br/&gt;  Breakdown dimensions and metrics must both be explicitly requested — nothing is added to the response just because a dimension was requested. Requesting AdGroupName, ProductId, or AdId as a breakdown requires the query to already be scoped to specific ad set(s), either via a non-empty adsetIds filter or by also including AdsetId in dimensions. Some metrics also require their own matching breakdown dimension to be requested — see the endpoint description for the full compatibility table. Results are capped at 100,000 rows; beyond that the response is truncated and a row-limit-exceeded warning is included.
     * @param adLevelReportRequestAttributesRequest  (optional)
     ...
     */
    public okhttp3.Call getAdLevelReportAsync(AdLevelReportRequestAttributesRequest adLevelReportRequestAttributesRequest, final ApiCallback<File> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAdLevelReportValidateBeforeCall(adLevelReportRequestAttributesRequest, _callback);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
    ...
    public okhttp3.Call getAdsetReportCall(StatisticsReportQueryMessage statisticsReportQueryMessage, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2027-01/statistics/report";
    ...
    /**
     * /2027-01/statistics/report (asynchronously)
     * This Statistics endpoint provides ad set related data. It is an upgrade of our previous Statistics endpoint, and includes new metrics and customization capabilities.  &lt;br/&gt;&lt;br/&gt;  This endpoint supports data retrieval for up to two years in the past.
     * @param statisticsReportQueryMessage  (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    public okhttp3.Call getPlacementsReportCall(PlacementsReportQueryMessageListRequest placementsReportQueryMessageListRequest, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2027-01/placements/report";
    ...
    /**
     * /2027-01/placements/report (asynchronously)
     * Your ads are placed in different domains (publishers) and environments (websites and apps). Thanks to the placements endpoint, you can analyse the performances for each publisher, comparing displays, clicks and sales generated.  &lt;br/&gt;&lt;br/&gt;  This endpoint supports data retrieval for up to three months in the past.
     * @param placementsReportQueryMessageListRequest  (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    public okhttp3.Call getTransactionsReportCall(TransactionsReportQueryMessageListRequest transactionsReportQueryMessageListRequest, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2027-01/transactions/report";
    ...
    /**
     * /2027-01/transactions/report (asynchronously)
     * This Transactions endpoint provides transactions id related data.  &lt;br/&gt;&lt;br/&gt;  This endpoint supports data retrieval for up to two years in the past.
     * @param transactionsReportQueryMessageListRequest  (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    public okhttp3.Call getTransparencyReportCall(String advertiserId, TransparencyQueryMessage transparencyQueryMessage, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2027-01/log-level/advertisers/{advertiser-id}/report"
    ...
    /**
     * /2027-01/log-level/advertisers/{advertiser-id}/report (asynchronously)
     * This Statistics endpoint provides publisher data.
     * @param advertiserId The advertiser ID to fetch the transparency data for. The advertiser must already exist. Must be greater than 0. (required)
     * @param transparencyQueryMessage The query message. (optional)
     * @param _callback The callback to be executed when the API call finishes
