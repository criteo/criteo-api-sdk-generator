...
import com.criteo.api.marketingsolutions.v2027_01.model.ResourceCollectionOutcomeOfAd;
import com.criteo.api.marketingsolutions.v2027_01.model.ResourceCollectionOutcomeOfCoupon;
import com.criteo.api.marketingsolutions.v2027_01.model.ResourceCollectionOutcomeOfCreativeRead;
import com.criteo.api.marketingsolutions.v2027_01.model.ResourceInputOfAdWrite;
import com.criteo.api.marketingsolutions.v2027_01.model.ResourceInputOfCreateCoupon;
import com.criteo.api.marketingsolutions.v2027_01.model.ResourceInputOfCreativeWrite;
import com.criteo.api.marketingsolutions.v2027_01.model.ResourceInputOfUpdateCoupon;
import com.criteo.api.marketingsolutions.v2027_01.model.ResourceOutcomeOfAd;
import com.criteo.api.marketingsolutions.v2027_01.model.ResourceOutcomeOfCoupon;
import com.criteo.api.marketingsolutions.v2027_01.model.ResourceOutcomeOfCouponSupportedSizes;
import com.criteo.api.marketingsolutions.v2027_01.model.ResourceOutcomeOfCreative;
...
public class CreativeApi {
    ...
    public okhttp3.Call createAdvertiserAdCall(String advertiserId, ResourceInputOfAdWrite resourceInputOfAdWrite, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/2027-01/marketing-solutions/advertisers/{advertiser-id}/ads"
    ...
    /**
     * /2027-01/marketing-solutions/advertisers/{advertiser-id}/ads (asynchronously)
     * Create an Ad
     * @param advertiserId The advertiser identifier. (required)
     * @param resourceInputOfAdWrite  (required)
    ...
    public okhttp3.Call createAdvertiserCouponCall(String advertiserId, ResourceInputOfCreateCoupon resourceInputOfCreateCoupon, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2027-01/marketing-solutions/advertisers/{advertiser-id}/coupons"
            .replace("{" + "advertiser-id" + "}", localVarApiClient.escapeString(advertiserId.toString()));
    ...
    /**
     * /2027-01/marketing-solutions/advertisers/{advertiser-id}/coupons (asynchronously)
     * Create a Coupon
     * @param advertiserId The advertiser identifier. (required)
     * @param resourceInputOfCreateCoupon  (required)
     * @param _callback The callback to be executed when the API call finishes
    ...
    public okhttp3.Call createAdvertiserCreativeCall(String advertiserId, ResourceInputOfCreativeWrite resourceInputOfCreativeWrite, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2027-01/marketing-solutions/advertisers/{advertiser-id}/creatives"
            .replace("{" + "advertiser-id" + "}", localVarApiClient.escapeString(advertiserId.toString()));
    ...
    /**
     * /2027-01/marketing-solutions/advertisers/{advertiser-id}/creatives (asynchronously)
     * Create a Creative
     * @param advertiserId The advertiser identifier. (required)
     * @param resourceInputOfCreativeWrite  (required)
     * @param _callback The callback to be executed when the API call finishes
    ...
    public okhttp3.Call deleteAdCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2027-01/marketing-solutions/ads/{id}"
    ...
    /**
     * /2027-01/marketing-solutions/ads/{id} (asynchronously)
     * Delete an Ad
     * @param id The ad identifier to delete. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    public okhttp3.Call deleteAdvertiserCouponCall(String advertiserId, String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2027-01/marketing-solutions/advertisers/{advertiser-id}/coupons/{id}"
            .replace("{" + "advertiser-id" + "}", localVarApiClient.escapeString(advertiserId.toString()))
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    /**
     * /2027-01/marketing-solutions/advertisers/{advertiser-id}/coupons/{id} (asynchronously)
     * Delete a Coupon
     * @param advertiserId The advertiser identifier. (required)
     * @param id The Coupon identifier to delete. (required)
     * @param _callback The callback to be executed when the API call finishes
    ...
    public okhttp3.Call deleteCreativeCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2027-01/marketing-solutions/creatives/{id}"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    /**
     * /2027-01/marketing-solutions/creatives/{id} (asynchronously)
     * Delete a Creative if there are no ads binded to it
     * @param id The creative identifier to delete. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    public okhttp3.Call generateCreativePreviewCall(String id, Integer height, Integer width, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2027-01/marketing-solutions/creatives/{id}/preview"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    /**
     * /2027-01/marketing-solutions/creatives/{id}/preview (asynchronously)
     * Get the preview of a specific Creative
     * @param id The Creative identifier to preview. (required)
     * @param height The height of the Creative to preview. (optional)
     * @param width The width of the Creative to preview. (optional)
    ...
    public okhttp3.Call getAdvertiserCouponPreviewCall(String advertiserId, String id, Integer height, Integer width, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2027-01/marketing-solutions/advertisers/{advertiser-id}/coupons/{id}/preview"
            .replace("{" + "advertiser-id" + "}", localVarApiClient.escapeString(advertiserId.toString()))
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    /**
     * /2027-01/marketing-solutions/advertisers/{advertiser-id}/coupons/{id}/preview (asynchronously)
     * Get the preview of a specific Coupon
     * @param advertiserId The advertiser identifier. (required)
     * @param id The Coupon identifier to preview. (required)
     * @param height The height of the coupon to preview. (optional)
    ...
    public okhttp3.Call getAdvertiserCouponSupportedSizesCall(String advertiserId, String adSetId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2027-01/marketing-solutions/advertisers/{advertiser-id}/coupons-supported-sizes"
            .replace("{" + "advertiser-id" + "}", localVarApiClient.escapeString(advertiserId.toString()));
    ...
    /**
     * /2027-01/marketing-solutions/advertisers/{advertiser-id}/coupons-supported-sizes (asynchronously)
     * Get the list of Coupon supported sizes
     * @param advertiserId The advertiser identifier. (required)
     * @param adSetId The ad set id on which you want to check the Coupon supported sizes. (optional)
     * @param _callback The callback to be executed when the API call finishes
