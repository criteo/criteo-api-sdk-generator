...
import com.criteo.api.marketingsolutions.v2027_01.model.Outcome;
import com.criteo.api.marketingsolutions.v2027_01.model.ResourceCollectionOutcomeOfProductSet;
import com.criteo.api.marketingsolutions.v2027_01.model.ResourceOutcomeOfProductSet;
import com.criteo.api.marketingsolutions.v2027_01.model.ValueResourceCollectionOutcomeOfBoostedAdProductSet;
import com.criteo.api.marketingsolutions.v2027_01.model.ValueResourceCollectionOutcomeOfProductFilterConfig;
import com.criteo.api.marketingsolutions.v2027_01.model.ValueResourceInputOfBoostingConfigurationRequest;
import com.criteo.api.marketingsolutions.v2027_01.model.ValueResourceInputOfCreateProductFilterRequest;
import com.criteo.api.marketingsolutions.v2027_01.model.ValueResourceInputOfCreateProductSetRequest;
import com.criteo.api.marketingsolutions.v2027_01.model.ValueResourceInputOfPatchProductSetRequest;
import com.criteo.api.marketingsolutions.v2027_01.model.ValueResourceOutcomeOfBoostedAdProductSet;
import com.criteo.api.marketingsolutions.v2027_01.model.ValueResourceOutcomeOfProductFilterConfig;
...
public class RecoApi {
    ...
    public okhttp3.Call createBoostedAdAssociationCall(String adId, String productSetId, ValueResourceInputOfBoostingConfigurationRequest valueResourceInputOfBoostingConfigurationRequest, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/2027-01/marketing-solutions/ads/{ad-id}/product-boost/{product-set-id}"
    ...
    /**
     * /2027-01/marketing-solutions/ads/{ad-id}/product-boost/{product-set-id} (asynchronously)
     * Create or update product boosting configuration
     * @param adId ID of the ad (required)
     * @param productSetId ID of the product set (required)
     * @param valueResourceInputOfBoostingConfigurationRequest  (optional)
    ...
    public okhttp3.Call createProductSetCall(ValueResourceInputOfCreateProductSetRequest valueResourceInputOfCreateProductSetRequest, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2027-01/marketing-solutions/product-sets";
    ...
    /**
     * /2027-01/marketing-solutions/product-sets (asynchronously)
     * Create a new product set
     * @param valueResourceInputOfCreateProductSetRequest  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    public okhttp3.Call disableProductFilteringCall(String adId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2027-01/marketing-solutions/ads/{ad-id}/product-filter"
            .replace("{" + "ad-id" + "}", localVarApiClient.escapeString(adId.toString()));
    ...
    /**
     * /2027-01/marketing-solutions/ads/{ad-id}/product-filter (asynchronously)
     * Disable product filtering for a given ad
     * @param adId ID of the ad (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    public okhttp3.Call fetchBoostedAdAssociationByPartnerIdCall(String datasetId, String clientType, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2027-01/marketing-solutions/dataset/{dataset-id}/product-boost"
    ...
    /**
     * /2027-01/marketing-solutions/dataset/{dataset-id}/product-boost (asynchronously)
     * Fetch boosting association and configuration for a given partner
     * @param datasetId ID of the dataset (required)
     * @param clientType Client type filter (optional)
     * @param _callback The callback to be executed when the API call finishes
    ...
    public okhttp3.Call fetchBoostedAdAssociationsCall(String adId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2027-01/marketing-solutions/ads/{ad-id}/product-boost"
            .replace("{" + "ad-id" + "}", localVarApiClient.escapeString(adId.toString()));
    ...
    /**
     * /2027-01/marketing-solutions/ads/{ad-id}/product-boost (asynchronously)
     * Fetch all boosting associations and configurations
     * @param adId ID of the ad (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    public okhttp3.Call fetchProductFilteringUsagesCall(String productSetId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2027-01/marketing-solutions/product-sets/{product-set-id}/product-filters"
            .replace("{" + "product-set-id" + "}", localVarApiClient.escapeString(productSetId.toString()));
    ...
    /**
     * /2027-01/marketing-solutions/product-sets/{product-set-id}/product-filters (asynchronously)
     * Fetch product filtering usages for a given product set
     * @param productSetId ID of the product set (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    public okhttp3.Call fetchProductSetCall(String productSetId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2027-01/marketing-solutions/product-sets/{product-set-id}"
            .replace("{" + "product-set-id" + "}", localVarApiClient.escapeString(productSetId.toString()));
    ...
    /**
     * /2027-01/marketing-solutions/product-sets/{product-set-id} (asynchronously)
     * Fetch an existing product set
     * @param productSetId ID of the product set (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    public okhttp3.Call fetchProductSetsCall(String datasetId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2027-01/marketing-solutions/product-sets/dataset/{dataset-id}"
            .replace("{" + "dataset-id" + "}", localVarApiClient.escapeString(datasetId.toString()));
    ...
    /**
     * /2027-01/marketing-solutions/product-sets/dataset/{dataset-id} (asynchronously)
     * Fetch product sets of a given dataset
     * @param datasetId The ID of the dataset that should be used for product set retrieval (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
