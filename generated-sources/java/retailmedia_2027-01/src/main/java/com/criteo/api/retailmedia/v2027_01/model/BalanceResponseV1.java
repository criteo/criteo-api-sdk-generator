...
public class BalanceResponseV1 {
  ...
  **/
  ...
  public BalanceResponseV1 retailerPoNumber(String retailerPoNumber) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.balanceType, balanceResponseV1.balanceType) &&
        ...
        Objects.equals(this.retailerPoNumber, balanceResponseV1.retailerPoNumber) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(balanceType, createdAt, deposited, endDate, memo, name, privateMarketBillingType, remaining, retailerPoNumber, spendType, spent, startDate, status, updatedAt);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("retailerPoNumber");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (!jsonObj.get("retailerPoNumber").isJsonPrimitive()) {
