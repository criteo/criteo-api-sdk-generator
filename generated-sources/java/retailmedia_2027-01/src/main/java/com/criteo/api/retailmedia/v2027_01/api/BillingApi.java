...
import com.criteo.api.retailmedia.v2027_01.model.EntityResourceOutcomePartnerBillingReportStatusV1;
import java.io.File;
import com.criteo.api.retailmedia.v2027_01.model.ValueResourceInputPartnerBillingReportRequestV1;
...
public class BillingApi {
    ...
    public okhttp3.Call createPartnerBillingReportRequestV1Call(ValueResourceInputPartnerBillingReportRequestV1 valueResourceInputPartnerBillingReportRequestV1, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/2027-01/retail-media/billing/partner-report";
    ...
    /**
     * /2027-01/retail-media/billing/partner-report (asynchronously)
     * Create a Partner Billing Report request.
     * @param valueResourceInputPartnerBillingReportRequestV1 Partner Billing Report request object. (required)
    ...
    public okhttp3.Call getPartnerBillingReportOutputV1Call(String requestId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2027-01/retail-media/billing/partner-report/{requestId}/output"
    ...
    /**
     * /2027-01/retail-media/billing/partner-report/{requestId}/output (asynchronously)
     * Get the output of an existing Partner Billing Report.
     * @param requestId The id of a Partner Billing Report request. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    public okhttp3.Call getPartnerBillingReportStatusV1Call(String requestId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/2027-01/retail-media/billing/partner-report/{requestId}/status"
            .replace("{" + "requestId" + "}", localVarApiClient.escapeString(requestId.toString()));
    ...
    /**
     * /2027-01/retail-media/billing/partner-report/{requestId}/status (asynchronously)
     * Get the status of an existing Partner Billing Report.
     * @param requestId The id of a Partner Billing Report request. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
