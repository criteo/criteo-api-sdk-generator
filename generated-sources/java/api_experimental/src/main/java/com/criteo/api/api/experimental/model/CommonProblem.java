...
public class CommonProblem {
  ...
  **/
  ...
  public CommonProblem traceIdentifier(String traceIdentifier) {
   ...
   /**
   * Deprecated. The request correlation ID this problem comes from.
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, detail, instance, source, stackTrace, title, traceId, traceIdentifier, type);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CommonProblem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CommonProblem` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
