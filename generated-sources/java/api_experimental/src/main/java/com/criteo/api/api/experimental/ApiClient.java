...
import com.criteo.api.api.experimental.auth.Authentication;
import com.criteo.api.api.experimental.auth.HttpBasicAuth;
import com.criteo.api.api.experimental.auth.HttpBearerAuth;
import com.criteo.api.api.experimental.auth.ApiKeyAuth;
import com.criteo.api.api.experimental.auth.OAuth;
import com.criteo.api.api.experimental.auth.RetryingOAuth;
import com.criteo.api.api.experimental.auth.OAuthFlow;
...
public class ApiClient {
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/0.0.260803/java");
     ...
     * @return a {@link com.criteo.api.api.experimental.ApiClient} object
     */
     ...
     * @throws com.criteo.api.api.experimental.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.criteo.api.api.experimental.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.criteo.api.api.experimental.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.criteo.api.api.experimental.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.criteo.api.api.experimental.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.criteo.api.api.experimental.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.criteo.api.api.experimental.ApiException If fails to update the parameters
     */
     ...
     * @throws com.criteo.api.api.experimental.ApiException If fail to serialize the request body object into a string
     */
