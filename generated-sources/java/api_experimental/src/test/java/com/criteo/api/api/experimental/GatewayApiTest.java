...
import com.criteo.api.api.experimental.ExampleApplication;
import com.criteo.api.api.experimental.api.GatewayApi;
import com.criteo.api.api.experimental.model.ApplicationSummaryModelResponse;

public class GatewayApiTest {
    private ApiClient client;

    private static String clientId = System.getenv("API_TEST_CLIENT_ID");
    private static String clientSecret = System.getenv("API_TEST_CLIENT_SECRET");
    private static Integer applicationId = Integer.parseInt(System.getenv("API_TEST_APPLICATION_ID"));
