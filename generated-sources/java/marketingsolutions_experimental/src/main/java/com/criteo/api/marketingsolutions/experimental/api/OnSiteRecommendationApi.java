...
import com.criteo.api.marketingsolutions.experimental.model.OnSiteRecoRequest;
import com.criteo.api.marketingsolutions.experimental.model.OnSiteRecoRequestConversational;
import com.criteo.api.marketingsolutions.experimental.model.OnSiteRecoResponse;
...
public class OnSiteRecommendationApi {
    ...
    public okhttp3.Call searchRecommendedProductsCall(OnSiteRecoRequest onSiteRecoRequest, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/experimental/recommendation/search";
    ...
    /**
     * /experimental/recommendation/search (asynchronously)
     * Retrieves a list of products recommended for the given user. This end point can either rely on a Criteo UserId, or a list of user events to perform the recommendation
     * @param onSiteRecoRequest  (optional)
    ...
    public okhttp3.Call searchRecommendedProductsConversationalCall(OnSiteRecoRequestConversational onSiteRecoRequestConversational, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/experimental/recommendation/search-conversational";
    ...
    /**
     * /experimental/recommendation/search-conversational (asynchronously)
     * Retrieves a list of products recommended for the given user based on a conversation between a user and a partner&#39;s agent
     * @param onSiteRecoRequestConversational  (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
