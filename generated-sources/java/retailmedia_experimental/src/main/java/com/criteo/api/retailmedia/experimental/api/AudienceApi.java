...
import com.criteo.api.retailmedia.experimental.model.RetailMediaContactlistAmendmentRequest;
import com.criteo.api.retailmedia.experimental.model.RetailMediaContactlistOperation;
...
import com.criteo.api.retailmedia.experimental.model.RmAudienceEntityV1RmAudienceSearchMetadataV1ListResponse;
import com.criteo.api.retailmedia.experimental.model.RmAudienceEstimateSizeInputV1;
import com.criteo.api.retailmedia.experimental.model.RmAudienceSearchInputV1;
import com.criteo.api.retailmedia.experimental.model.RmAudienceSegmentBulkCreateInputV1;
import com.criteo.api.retailmedia.experimental.model.RmAudienceSegmentBulkDeleteInputV1;
import com.criteo.api.retailmedia.experimental.model.RmAudienceSegmentBulkUpdateInputV1;
import com.criteo.api.retailmedia.experimental.model.RmAudienceSegmentComputeSizesInputV1;
import com.criteo.api.retailmedia.experimental.model.RmAudienceSegmentEntityV1ListResponse;
import com.criteo.api.retailmedia.experimental.model.RmAudienceSegmentEntityV1RmAudienceSegmentSearchMetadataV1ListResponse;
...
import com.criteo.api.retailmedia.experimental.model.RmAudienceSegmentSearchInputV1;
...
import com.criteo.api.retailmedia.experimental.model.RmContactListStatisticsEntityV1Response;
...
public class AudienceApi {
    ...
    public okhttp3.Call addRemoveContactListByAudienceSegmentCall(String audienceSegmentId, RetailMediaContactlistAmendmentRequest retailMediaContactlistAmendmentRequest, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/experimental/retail-media/audience-segments/{audience-segment-id}/contact-list/add-remove"
    ...
    /**
     * /experimental/retail-media/audience-segments/{audience-segment-id}/contact-list/add-remove (asynchronously)
     * Add/remove identifiers to or from a retail-media contact list audience-segment, with external audience segment id.
     * @param audienceSegmentId The id of the contact list audience-segment to amend, we only accept external Id here (required)
     * @param retailMediaContactlistAmendmentRequest  (required)
    ...
    public okhttp3.Call bulkCreateAudienceSegmentsCall(String accountId, RmAudienceSegmentBulkCreateInputV1 rmAudienceSegmentBulkCreateInputV1, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/experimental/retail-media/accounts/{account-id}/audience-segments/create"
            .replace("{" + "account-id" + "}", localVarApiClient.escapeString(accountId.toString()));
    ...
    /**
     * /experimental/retail-media/accounts/{account-id}/audience-segments/create (asynchronously)
     * Creates all segments with a valid configuration, and returns the full segments. For those that cannot be created, one or multiple errors are returned.
     * @param accountId Account Id (required)
     * @param rmAudienceSegmentBulkCreateInputV1 Segment creation parameter (required)
     * @param _callback The callback to be executed when the API call finishes
    ...
    public okhttp3.Call bulkDeleteAudienceSegmentsCall(String accountId, RmAudienceSegmentBulkDeleteInputV1 rmAudienceSegmentBulkDeleteInputV1, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/experimental/retail-media/accounts/{account-id}/audience-segments/delete"
            .replace("{" + "account-id" + "}", localVarApiClient.escapeString(accountId.toString()));
    ...
    /**
     * /experimental/retail-media/accounts/{account-id}/audience-segments/delete (asynchronously)
     * Delete the segments associated to the given IDs.
     * @param accountId Account id (required)
     * @param rmAudienceSegmentBulkDeleteInputV1 Segment delete request. (required)
     * @param _callback The callback to be executed when the API call finishes
    ...
    public okhttp3.Call bulkUpdateAudienceSegmentsCall(String accountId, RmAudienceSegmentBulkUpdateInputV1 rmAudienceSegmentBulkUpdateInputV1, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/experimental/retail-media/accounts/{account-id}/audience-segments"
            .replace("{" + "account-id" + "}", localVarApiClient.escapeString(accountId.toString()));
    ...
    /**
     * /experimental/retail-media/accounts/{account-id}/audience-segments (asynchronously)
     * Updates the properties of all segments with a valid configuration, and returns the full segments. For those that cannot be updated, one or multiple errors are returned.
     * @param accountId Account id (required)
     * @param rmAudienceSegmentBulkUpdateInputV1 Segment Update request (required)
     * @param _callback The callback to be executed when the API call finishes
    ...
    public okhttp3.Call clearContactListByAudienceSegmentCall(String audienceSegmentId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/experimental/retail-media/audience-segments/{audience-segment-id}/contact-list/clear"
            .replace("{" + "audience-segment-id" + "}", localVarApiClient.escapeString(audienceSegmentId.toString()));
    ...
    /**
     * /experimental/retail-media/audience-segments/{audience-segment-id}/contact-list/clear (asynchronously)
     * Delete all identifiers from a retail-media contact list audience-segment, with external audience segment id.
     * @param audienceSegmentId The id of the contact list audience-segment to amend, we only accept external Id here (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    public okhttp3.Call getAudienceSegmentContactListStatisticsCall(String accountId, String audienceSegmentId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/experimental/retail-media/accounts/{account-id}/audience-segments/{audience-segment-id}/contact-list"
            .replace("{" + "account-id" + "}", localVarApiClient.escapeString(accountId.toString()))
            .replace("{" + "audience-segment-id" + "}", localVarApiClient.escapeString(audienceSegmentId.toString()));
    ...
    /**
     * /experimental/retail-media/accounts/{account-id}/audience-segments/{audience-segment-id}/contact-list (asynchronously)
     * Returns the statistics of a contact list segment.
     * @param accountId Account Id (required)
     * @param audienceSegmentId Segment Id. (required)
     * @param _callback The callback to be executed when the API call finishes
    ...
    public okhttp3.Call searchAudienceSegmentsCall(String accountId, RmAudienceSegmentSearchInputV1 rmAudienceSegmentSearchInputV1, Integer limit, Integer offset, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/experimental/retail-media/accounts/{account-id}/audience-segments/search"
            .replace("{" + "account-id" + "}", localVarApiClient.escapeString(accountId.toString()));
    ...
    /**
     * /experimental/retail-media/accounts/{account-id}/audience-segments/search (asynchronously)
     * Returns a list of segments that match the provided filters. If present, the filters are AND&#39;ed together when applied.
     * @param accountId Account Id (required)
     * @param rmAudienceSegmentSearchInputV1 Segment search filters. (required)
     * @param limit The number of elements to be returned. The default is 50 and the maximum is 500. (optional, default to 50)
    ...
    public okhttp3.Call searchAudiencesCall(String accountId, RmAudienceSearchInputV1 rmAudienceSearchInputV1, Integer limit, Integer offset, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/experimental/retail-media/accounts/{account-id}/audiences/search"
            .replace("{" + "account-id" + "}", localVarApiClient.escapeString(accountId.toString()));
    ...
    /**
     * /experimental/retail-media/accounts/{account-id}/audiences/search (asynchronously)
     * Returns a list of audiences that match the provided filters. If present, the filters are AND&#39;ed together when applied.
     * @param accountId Account Id (required)
     * @param rmAudienceSearchInputV1 Audience search filters. (required)
     * @param limit The number of elements to be returned. The default is 50 and the maximum is 500. (optional, default to 50)
