...
import com.criteo.api.retailmedia.experimental.model.EntityResourceOutcomeOfRetailMediaAccountV2;
import com.criteo.api.retailmedia.experimental.model.GrantConsentInput;
import com.criteo.api.retailmedia.experimental.model.ValueResourceCollectionInputOfRetailMediaSeller;
import com.criteo.api.retailmedia.experimental.model.ValueResourceCollectionOutcomeOfRetailMediaSeller;
import com.criteo.api.retailmedia.experimental.model.ValueResourceInputOfRetailMediaBrandAccountCreationV2;
import com.criteo.api.retailmedia.experimental.model.ValueResourceInputOfRetailMediaBrands;
import com.criteo.api.retailmedia.experimental.model.ValueResourceInputOfRetailMediaSellerAccountCreationV2;
import com.criteo.api.retailmedia.experimental.model.ValueResourceOutcomeOfRetailMediaBrands;
...
public class ThirdPartyAccountsApi {
    ...
    public okhttp3.Call addThirdPartyAccountBrandsCall(String accountId, ValueResourceInputOfRetailMediaBrands valueResourceInputOfRetailMediaBrands, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/experimental/retail-media/third-party-accounts/{accountId}/brands/add"
    ...
    /**
     * /experimental/retail-media/third-party-accounts/{accountId}/brands/add (asynchronously)
     * add the provided brands to an account. This will not remove any existing brands.
     * @param accountId account to add brands to (required)
     * @param valueResourceInputOfRetailMediaBrands list of bands to add to an account (optional)
    ...
    public okhttp3.Call createThirdPartyBrandAccountCall(String accountId, ValueResourceInputOfRetailMediaBrandAccountCreationV2 valueResourceInputOfRetailMediaBrandAccountCreationV2, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/experimental/retail-media/third-party-accounts/{accountId}/create-brand-account"
            .replace("{" + "accountId" + "}", localVarApiClient.escapeString(accountId.toString()));
    ...
    /**
     * /experimental/retail-media/third-party-accounts/{accountId}/create-brand-account (asynchronously)
     * Create a private market demand brand account under a given parent account.
     * @param accountId parent supply account to create account under (required)
     * @param valueResourceInputOfRetailMediaBrandAccountCreationV2  (optional)
     * @param _callback The callback to be executed when the API call finishes
    ...
    public okhttp3.Call createThirdPartySellerAccountCall(String accountId, ValueResourceInputOfRetailMediaSellerAccountCreationV2 valueResourceInputOfRetailMediaSellerAccountCreationV2, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/experimental/retail-media/third-party-accounts/{accountId}/create-seller-account"
            .replace("{" + "accountId" + "}", localVarApiClient.escapeString(accountId.toString()));
    ...
    /**
     * /experimental/retail-media/third-party-accounts/{accountId}/create-seller-account (asynchronously)
     * Create a private market demand seller account under a given parent account.
     * @param accountId parent supply account to create account under (required)
     * @param valueResourceInputOfRetailMediaSellerAccountCreationV2  (optional)
     * @param _callback The callback to be executed when the API call finishes
    ...
    public okhttp3.Call grantThirdPartyConsentCall(String accountId, GrantConsentInput grantConsentInput, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/experimental/retail-media/accounts/{accountId}/grant-third-party-consent"
            .replace("{" + "accountId" + "}", localVarApiClient.escapeString(accountId.toString()));
    ...
    /**
     * /experimental/retail-media/accounts/{accountId}/grant-third-party-consent (asynchronously)
     * Grant third-party consent to a business application on behalf of a Private Market demand account
     * @param accountId The demand account ID on which to grant consent (required)
     * @param grantConsentInput The request input containing clientId, callbackURL, and callbackState (optional)
     * @param _callback The callback to be executed when the API call finishes
    ...
    public okhttp3.Call removeThirdPartyAccountBrandCall(String accountId, String brandId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/experimental/retail-media/third-party-accounts/{accountId}/brands/{brandId}/remove"
            .replace("{" + "accountId" + "}", localVarApiClient.escapeString(accountId.toString()))
    ...
    /**
     * /experimental/retail-media/third-party-accounts/{accountId}/brands/{brandId}/remove (asynchronously)
     * Attempt to remove the provided brand from the account.
     * @param accountId account id to remove brand from (required)
     * @param brandId brand to remove (required)
     * @param _callback The callback to be executed when the API call finishes
    ...
    public okhttp3.Call updateThirdPartyAccountSellersCall(String accountId, ValueResourceCollectionInputOfRetailMediaSeller valueResourceCollectionInputOfRetailMediaSeller, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/experimental/retail-media/third-party-accounts/{accountId}/sellers"
            .replace("{" + "accountId" + "}", localVarApiClient.escapeString(accountId.toString()));
    ...
    /**
     * /experimental/retail-media/third-party-accounts/{accountId}/sellers (asynchronously)
     * Update the list of sellers mapped to the account. This will override any existing mappings.
     * @param accountId accountId to update sellers for (required)
     * @param valueResourceCollectionInputOfRetailMediaSeller  (required)
     * @param _callback The callback to be executed when the API call finishes
