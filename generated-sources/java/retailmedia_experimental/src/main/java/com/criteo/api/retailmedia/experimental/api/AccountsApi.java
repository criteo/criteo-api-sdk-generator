...
import com.criteo.api.retailmedia.experimental.model.EntityResourceCollectionOutcomeOfRetailMediaChildAccountAndMetadata;
...
public class AccountsApi {
    ...
    public okhttp3.Call getPrivateMarketChildAccountsByAccountIdCall(String accountId, Integer limit, Integer offset, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/experimental/retail-media/account-management/accounts/{accountId}/private-market-child-accounts"
    ...
    /**
     * /experimental/retail-media/account-management/accounts/{accountId}/private-market-child-accounts (asynchronously)
     * Gets Private Market child accounts that are associated with the given account
     * @param accountId Account Id (required)
     * @param limit The number of accounts to be returned. The default is 25. (optional, default to 25)
     * @param offset The (zero-based) offset into the collection of accounts. The default is 0. (optional, default to 0)
