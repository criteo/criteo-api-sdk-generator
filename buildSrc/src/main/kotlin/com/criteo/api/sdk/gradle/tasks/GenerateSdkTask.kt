...
open class GenerateSdkTask : GenerateTask()
{
    ...
    open protected fun computeGeneratorOptions()
    {
        ...
        configOptions.put("scmConnection"            , "scm:git:git://github.com/criteo/criteo-api-${language}-sdk.git")
        configOptions.put("scmDeveloperConnection"   , "scm:git:ssh://github.com:criteo/criteo-api-${language}-sdk.git")
